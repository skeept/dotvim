...
nmake -f Make_mvc.mak  DYNAMIC_PYTHON=yes PYTHON="C:\Python27_64" PYTHON_VER=27 PERL="C:\Perl64" PERL_VER=516 DYNAMIC_PERL=yes FEATURES=HUGE OLE=yes CPU=AMD64 GUI=no %*

nmake -f Make_mvc.mak  DYNAMIC_PYTHON=yes PYTHON="C:\Python27_64" PYTHON_VER=27 PERL="C:\Perl64" PERL_VER=516 DYNAMIC_PERL=yes FEATURES=HUGE OLE=yes CPU=AMD64 GUI=yes %*
