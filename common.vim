...
set whichwrap=<,>,[,],h,l
set nopaste
if !has("nvim") " recent versions of nvim don't have this
...
if g:is_vimrc_simple == 0
  augroup ft_py_pysmell_or_jedi
    autocmd!
    " Skip jedi when ALE is handling Python (via basedpyright + ruff)
    autocmd FileType python if !IsAddonActive('ale') | call jraf#loadJedi() | endif
  augroup END
endif
