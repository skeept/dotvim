...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsole) || &term =~? "^konsole"
    CSAHi Normal term=NONE cterm=NONE ctermbg=250 ctermfg=16 gui=NONE guibg=grey guifg=black
    ...
    CSAHi NonText term=bold cterm=bold ctermbg=250 ctermfg=21 gui=bold guibg=grey guifg=Blue
    ...
    CSAHi IncSearch term=reverse cterm=NONE ctermbg=16 ctermfg=250 gui=reverse guibg=bg guifg=fg
    ...
    CSAHi PmenuThumb term=NONE cterm=NONE ctermbg=16 ctermfg=250 gui=reverse guibg=bg guifg=fg
    CSAHi TabLine term=underline cterm=underline ctermbg=252 ctermfg=fg gui=underline guibg=LightGrey guifg=fg
    CSAHi TabLineSel term=bold cterm=bold ctermbg=bg ctermfg=fg gui=bold guibg=bg guifg=fg
    CSAHi TabLineFill term=reverse cterm=NONE ctermbg=16 ctermfg=250 gui=reverse guibg=bg guifg=fg
    CSAHi CursorColumn term=reverse cterm=NONE ctermbg=254 ctermfg=fg gui=NONE guibg=Grey90 guifg=fg
    CSAHi CursorLine term=underline cterm=NONE ctermbg=254 ctermfg=fg gui=NONE guibg=Grey90 guifg=fg
    CSAHi Cursor term=NONE cterm=NONE ctermbg=196 ctermfg=231 gui=reverse guibg=white guifg=red
    CSAHi Question term=NONE cterm=bold ctermbg=bg ctermfg=72 gui=bold guibg=bg guifg=SeaGreen
    CSAHi StatusLine term=reverse,bold cterm=bold ctermbg=16 ctermfg=250 gui=reverse,bold guibg=bg guifg=fg
    CSAHi StatusLineNC term=reverse cterm=NONE ctermbg=16 ctermfg=250 gui=reverse guibg=bg guifg=fg
    CSAHi VertSplit term=reverse cterm=NONE ctermbg=16 ctermfg=250 gui=reverse guibg=bg guifg=fg
    CSAHi Title term=bold cterm=bold ctermbg=bg ctermfg=201 gui=bold guibg=bg guifg=Magenta
    CSAHi Visual term=reverse cterm=NONE ctermbg=226 ctermfg=16 gui=reverse guibg=Black guifg=Yellow
    ...
    CSAHi lCursor term=NONE cterm=NONE ctermbg=46 ctermfg=16 gui=NONE guibg=green guifg=black
    CSAHi MatchParen term=reverse cterm=NONE ctermbg=51 ctermfg=fg gui=NONE guibg=Cyan guifg=fg
    CSAHi Comment term=bold cterm=NONE ctermbg=bg ctermfg=226 gui=NONE guibg=bg guifg=Yellow
    CSAHi Constant term=underline cterm=NONE ctermbg=250 ctermfg=21 gui=NONE guibg=grey guifg=Blue
    CSAHi Special term=bold cterm=NONE ctermbg=250 ctermfg=124 gui=NONE guibg=grey guifg=darkred
    ...
    CSAHi Type term=underline cterm=bold ctermbg=bg ctermfg=28 gui=bold guibg=bg guifg=DarkGreen
...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_eterm") && g:CSApprox_eterm) || &term =~? "^eterm"
    ...
    CSAHi CursorColumn term=reverse cterm=NONE ctermbg=254 ctermfg=fg gui=NONE guibg=Grey90 guifg=fg
    CSAHi CursorLine term=underline cterm=NONE ctermbg=254 ctermfg=fg gui=NONE guibg=Grey90 guifg=fg
    CSAHi Cursor term=NONE cterm=NONE ctermbg=196 ctermfg=255 gui=reverse guibg=white guifg=red
    CSAHi Question term=NONE cterm=bold ctermbg=bg ctermfg=72 gui=bold guibg=bg guifg=SeaGreen
    CSAHi StatusLine term=reverse,bold cterm=bold ctermbg=16 ctermfg=250 gui=reverse,bold guibg=bg guifg=fg
    CSAHi StatusLineNC term=reverse cterm=NONE ctermbg=16 ctermfg=250 gui=reverse guibg=bg guifg=fg
    CSAHi VertSplit term=reverse cterm=NONE ctermbg=16 ctermfg=250 gui=reverse guibg=bg guifg=fg
...
elseif has("gui_running") || &t_Co == 256
    ...
    CSAHi Comment term=bold cterm=NONE ctermbg=bg ctermfg=226 gui=NONE guibg=bg guifg=Yellow
    CSAHi Constant term=underline cterm=NONE ctermbg=250 ctermfg=21 gui=NONE guibg=grey guifg=Blue
    CSAHi Special term=bold cterm=NONE ctermbg=250 ctermfg=88 gui=NONE guibg=grey guifg=darkred
    ...
    CSAHi Type term=underline cterm=bold ctermbg=bg ctermfg=22 gui=bold guibg=bg guifg=DarkGreen
...
elseif has("gui_running") || &t_Co == 88
    CSAHi Normal term=NONE cterm=NONE ctermbg=85 ctermfg=16 gui=NONE guibg=grey guifg=black
    ...
    CSAHi NonText term=bold cterm=bold ctermbg=85 ctermfg=19 gui=bold guibg=grey guifg=Blue
    ...
    CSAHi IncSearch term=reverse cterm=NONE ctermbg=16 ctermfg=85 gui=reverse guibg=bg guifg=fg
    ...
    CSAHi PmenuThumb term=NONE cterm=NONE ctermbg=16 ctermfg=85 gui=reverse guibg=bg guifg=fg
    CSAHi TabLine term=underline cterm=underline ctermbg=86 ctermfg=fg gui=underline guibg=LightGrey guifg=fg
    CSAHi TabLineSel term=bold cterm=bold ctermbg=bg ctermfg=fg gui=bold guibg=bg guifg=fg
    CSAHi TabLineFill term=reverse cterm=NONE ctermbg=16 ctermfg=85 gui=reverse guibg=bg guifg=fg
    CSAHi CursorColumn term=reverse cterm=NONE ctermbg=87 ctermfg=fg gui=NONE guibg=Grey90 guifg=fg
    CSAHi CursorLine term=underline cterm=NONE ctermbg=87 ctermfg=fg gui=NONE guibg=Grey90 guifg=fg
    CSAHi Cursor term=NONE cterm=NONE ctermbg=64 ctermfg=79 gui=reverse guibg=white guifg=red
    CSAHi Question term=NONE cterm=bold ctermbg=bg ctermfg=21 gui=bold guibg=bg guifg=SeaGreen
    CSAHi StatusLine term=reverse,bold cterm=bold ctermbg=16 ctermfg=85 gui=reverse,bold guibg=bg guifg=fg
    CSAHi StatusLineNC term=reverse cterm=NONE ctermbg=16 ctermfg=85 gui=reverse guibg=bg guifg=fg
    CSAHi VertSplit term=reverse cterm=NONE ctermbg=16 ctermfg=85 gui=reverse guibg=bg guifg=fg
    CSAHi Title term=bold cterm=bold ctermbg=bg ctermfg=67 gui=bold guibg=bg guifg=Magenta
    CSAHi Visual term=reverse cterm=NONE ctermbg=76 ctermfg=16 gui=reverse guibg=Black guifg=Yellow
    CSAHi VisualNOS term=bold,underline cterm=bold,underline ctermbg=bg ctermfg=fg gui=bold,underline guibg=bg guifg=fg
    ...
    CSAHi lCursor term=NONE cterm=NONE ctermbg=28 ctermfg=16 gui=NONE guibg=green guifg=black
    CSAHi MatchParen term=reverse cterm=NONE ctermbg=31 ctermfg=fg gui=NONE guibg=Cyan guifg=fg
    CSAHi Comment term=bold cterm=NONE ctermbg=bg ctermfg=76 gui=NONE guibg=bg guifg=Yellow
    CSAHi Constant term=underline cterm=NONE ctermbg=85 ctermfg=19 gui=NONE guibg=grey guifg=Blue
    CSAHi Special term=bold cterm=NONE ctermbg=85 ctermfg=32 gui=NONE guibg=grey guifg=darkred
    ...
    CSAHi Type term=underline cterm=bold ctermbg=bg ctermfg=20 gui=bold guibg=bg guifg=DarkGreen
