...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsole) || &term =~? "^konsole"
    ...
    CSAHi Comment term=bold cterm=NONE ctermbg=bg ctermfg=72 gui=NONE guibg=bg guifg=SeaGreen
    CSAHi Constant term=underline cterm=NONE ctermbg=bg ctermfg=25 gui=NONE guibg=bg guifg=#004488
    CSAHi Special term=bold cterm=NONE ctermbg=bg ctermfg=74 gui=NONE guibg=bg guifg=SteelBlue
    ...
    CSAHi PreProc term=underline cterm=NONE ctermbg=bg ctermfg=21 gui=NONE guibg=bg guifg=Blue
...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_eterm") && g:CSApprox_eterm) || &term =~? "^eterm"
    ...
    CSAHi MatchParen term=reverse cterm=NONE ctermbg=51 ctermfg=fg gui=NONE guibg=Cyan guifg=fg
    CSAHi Comment term=bold cterm=NONE ctermbg=bg ctermfg=72 gui=NONE guibg=bg guifg=SeaGreen
    CSAHi Constant term=underline cterm=NONE ctermbg=bg ctermfg=31 gui=NONE guibg=bg guifg=#004488
    CSAHi Special term=bold cterm=NONE ctermbg=bg ctermfg=110 gui=NONE guibg=bg guifg=SteelBlue
    CSAHi Identifier term=underline cterm=NONE ctermbg=bg ctermfg=37 gui=NONE guibg=bg guifg=DarkCyan
    CSAHi Statement term=bold cterm=NONE ctermbg=bg ctermfg=21 gui=NONE guibg=bg guifg=Blue
    CSAHi PreProc term=underline cterm=NONE ctermbg=bg ctermfg=21 gui=NONE guibg=bg guifg=Blue
    CSAHi Type term=underline cterm=NONE ctermbg=bg ctermfg=21 gui=NONE guibg=bg guifg=Blue
...
elseif has("gui_running") || &t_Co == 256
    ...
    CSAHi lCursor term=NONE cterm=NONE ctermbg=16 ctermfg=231 gui=NONE guibg=fg guifg=bg
    CSAHi MatchParen term=reverse cterm=NONE ctermbg=51 ctermfg=fg gui=NONE guibg=Cyan guifg=fg
    CSAHi Comment term=bold cterm=NONE ctermbg=bg ctermfg=29 gui=NONE guibg=bg guifg=SeaGreen
    CSAHi Constant term=underline cterm=NONE ctermbg=bg ctermfg=24 gui=NONE guibg=bg guifg=#004488
    CSAHi Special term=bold cterm=NONE ctermbg=bg ctermfg=67 gui=NONE guibg=bg guifg=SteelBlue
...
elseif has("gui_running") || &t_Co == 88
    ...
    CSAHi Comment term=bold cterm=NONE ctermbg=bg ctermfg=21 gui=NONE guibg=bg guifg=SeaGreen
    CSAHi Constant term=underline cterm=NONE ctermbg=bg ctermfg=17 gui=NONE guibg=bg guifg=#004488
    CSAHi Special term=bold cterm=NONE ctermbg=bg ctermfg=38 gui=NONE guibg=bg guifg=SteelBlue
    ...
    CSAHi PreProc term=underline cterm=NONE ctermbg=bg ctermfg=19 gui=NONE guibg=bg guifg=Blue
