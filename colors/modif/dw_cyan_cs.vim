...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsole) || &term =~? "^konsole"
    ...
    CSAHi String term=NONE cterm=NONE ctermbg=bg ctermfg=44 gui=NONE guibg=bg guifg=#00bbbb
    CSAHi Boolean term=NONE cterm=NONE ctermbg=bg ctermfg=51 gui=NONE guibg=bg guifg=#00ffff
    CSAHi Function term=NONE cterm=NONE ctermbg=16 ctermfg=51 gui=NONE guibg=#000000 guifg=#00ffff
    ...
    CSAHi IncSearch term=reverse cterm=NONE ctermbg=44 ctermfg=16 gui=NONE guibg=#00bbbb guifg=#000000
    CSAHi Search term=reverse cterm=NONE ctermbg=51 ctermfg=16 gui=NONE guibg=#00ffff guifg=#000000
    CSAHi MoreMsg term=bold cterm=bold ctermbg=16 ctermfg=51 gui=bold guibg=#000000 guifg=#00ffff
    CSAHi ModeMsg term=bold cterm=bold ctermbg=16 ctermfg=51 gui=bold guibg=#000000 guifg=#00ffff
    CSAHi LineNr term=underline cterm=NONE ctermbg=16 ctermfg=37 gui=NONE guibg=#000000 guifg=#008888
    ...
    CSAHi TabLineSel term=bold cterm=NONE ctermbg=37 ctermfg=16 gui=NONE guibg=#00aaaa guifg=#000000
    CSAHi TabLineFill term=reverse cterm=underline ctermbg=16 ctermfg=231 gui=underline guibg=#000000 guifg=#ffffff
    CSAHi CursorColumn term=reverse cterm=NONE ctermbg=16 ctermfg=fg gui=NONE guibg=#001111 guifg=fg
    CSAHi CursorLine term=underline cterm=NONE ctermbg=16 ctermfg=fg gui=NONE guibg=#001818 guifg=fg
    ...
    CSAHi cDefine term=NONE cterm=NONE ctermbg=bg ctermfg=51 gui=NONE guibg=bg guifg=#00ffff
    CSAHi Question term=NONE cterm=bold ctermbg=bg ctermfg=51 gui=bold guibg=bg guifg=#00ffff
    CSAHi StatusLine term=reverse,bold cterm=NONE ctermbg=51 ctermfg=16 gui=NONE guibg=#00ffff guifg=#000000
    ...
    CSAHi Title term=bold cterm=NONE ctermbg=bg ctermfg=51 gui=NONE guibg=bg guifg=#00ffff
    CSAHi Visual term=reverse cterm=NONE ctermbg=44 ctermfg=16 gui=NONE guibg=#00dddd guifg=#000000
    ...
    CSAHi MatchParen term=reverse cterm=NONE ctermbg=235 ctermfg=51 gui=NONE guibg=#222222 guifg=#00ffff
    ...
    CSAHi Identifier term=underline cterm=NONE ctermbg=16 ctermfg=44 gui=NONE guibg=#000000 guifg=#00cccc
    ...
    CSAHi DiffAdd term=bold cterm=NONE ctermbg=59 ctermfg=51 gui=NONE guibg=#333333 guifg=#00ffff
    CSAHi DiffChange term=bold cterm=NONE ctermbg=59 ctermfg=51 gui=NONE guibg=#333333 guifg=#00ffff
    CSAHi DiffDelete term=bold cterm=bold ctermbg=59 ctermfg=51 gui=bold guibg=#333333 guifg=#00ffff
...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_eterm") && g:CSApprox_eterm) || &term =~? "^eterm"
    ...
    CSAHi PmenuThumb term=NONE cterm=NONE ctermbg=250 ctermfg=16 gui=reverse guibg=bg guifg=fg
    CSAHi TabLine term=underline cterm=NONE ctermbg=238 ctermfg=16 gui=NONE guibg=#444444 guifg=#000000
    CSAHi TabLineSel term=bold cterm=NONE ctermbg=44 ctermfg=16 gui=NONE guibg=#00aaaa guifg=#000000
    CSAHi TabLineFill term=reverse cterm=underline ctermbg=16 ctermfg=255 gui=underline guibg=#000000 guifg=#ffffff
    CSAHi CursorColumn term=reverse cterm=NONE ctermbg=16 ctermfg=fg gui=NONE guibg=#001111 guifg=fg
    CSAHi CursorLine term=underline cterm=NONE ctermbg=23 ctermfg=fg gui=NONE guibg=#001818 guifg=fg
    ...
    CSAHi Title term=bold cterm=NONE ctermbg=bg ctermfg=51 gui=NONE guibg=bg guifg=#00ffff
    CSAHi Visual term=reverse cterm=NONE ctermbg=51 ctermfg=16 gui=NONE guibg=#00dddd guifg=#000000
    CSAHi VisualNOS term=bold,underline cterm=bold,underline ctermbg=bg ctermfg=fg gui=bold,underline guibg=bg guifg=fg
    CSAHi WarningMsg term=NONE cterm=NONE ctermbg=245 ctermfg=16 gui=NONE guibg=#888888 guifg=#000000
    CSAHi WildMenu term=NONE cterm=NONE ctermbg=226 ctermfg=16 gui=NONE guibg=Yellow guifg=Black
    CSAHi Folded term=NONE cterm=NONE ctermbg=235 ctermfg=196 gui=NONE guibg=#222222 guifg=#ff0000
    ...
    CSAHi Identifier term=underline cterm=NONE ctermbg=16 ctermfg=51 gui=NONE guibg=#000000 guifg=#00cccc
    CSAHi Statement term=bold cterm=bold ctermbg=bg ctermfg=51 gui=bold guibg=bg guifg=#00ffff
    ...
    CSAHi FoldColumn term=NONE cterm=NONE ctermbg=235 ctermfg=196 gui=NONE guibg=#222222 guifg=#ff0000
    CSAHi DiffAdd term=bold cterm=NONE ctermbg=236 ctermfg=51 gui=NONE guibg=#333333 guifg=#00ffff
    CSAHi DiffChange term=bold cterm=NONE ctermbg=236 ctermfg=51 gui=NONE guibg=#333333 guifg=#00ffff
    CSAHi DiffDelete term=bold cterm=bold ctermbg=236 ctermfg=51 gui=bold guibg=#333333 guifg=#00ffff
...
elseif has("gui_running") || &t_Co == 256
    ...
    CSAHi Error term=reverse cterm=NONE ctermbg=196 ctermfg=231 gui=NONE guibg=Red guifg=White
    CSAHi Todo term=NONE cterm=NONE ctermbg=16 ctermfg=196 gui=NONE guibg=#000000 guifg=#ff0000
    CSAHi String term=NONE cterm=NONE ctermbg=bg ctermfg=37 gui=NONE guibg=bg guifg=#00bbbb
    CSAHi Boolean term=NONE cterm=NONE ctermbg=bg ctermfg=51 gui=NONE guibg=bg guifg=#00ffff
    CSAHi Function term=NONE cterm=NONE ctermbg=16 ctermfg=51 gui=NONE guibg=#000000 guifg=#00ffff
    CSAHi SpecialKey term=bold cterm=NONE ctermbg=16 ctermfg=51 gui=NONE guibg=#000000 guifg=#00ffff
    CSAHi NonText term=bold cterm=bold ctermbg=16 ctermfg=231 gui=bold guibg=#000000 guifg=#ffffff
    CSAHi Directory term=bold cterm=NONE ctermbg=16 ctermfg=51 gui=NONE guibg=#000000 guifg=#00ffff
    CSAHi ErrorMsg term=NONE cterm=NONE ctermbg=231 ctermfg=16 gui=NONE guibg=#ffffff guifg=#000000
    CSAHi IncSearch term=reverse cterm=NONE ctermbg=37 ctermfg=16 gui=NONE guibg=#00bbbb guifg=#000000
    CSAHi Search term=reverse cterm=NONE ctermbg=51 ctermfg=16 gui=NONE guibg=#00ffff guifg=#000000
    CSAHi MoreMsg term=bold cterm=bold ctermbg=16 ctermfg=51 gui=bold guibg=#000000 guifg=#00ffff
    CSAHi ModeMsg term=bold cterm=bold ctermbg=16 ctermfg=51 gui=bold guibg=#000000 guifg=#00ffff
    CSAHi LineNr term=underline cterm=NONE ctermbg=16 ctermfg=30 gui=NONE guibg=#000000 guifg=#008888
...
elseif has("gui_running") || &t_Co == 88
    ...
    CSAHi String term=NONE cterm=NONE ctermbg=bg ctermfg=26 gui=NONE guibg=bg guifg=#00bbbb
    CSAHi Boolean term=NONE cterm=NONE ctermbg=bg ctermfg=31 gui=NONE guibg=bg guifg=#00ffff
    CSAHi Function term=NONE cterm=NONE ctermbg=16 ctermfg=31 gui=NONE guibg=#000000 guifg=#00ffff
    ...
    CSAHi IncSearch term=reverse cterm=NONE ctermbg=26 ctermfg=16 gui=NONE guibg=#00bbbb guifg=#000000
    CSAHi Search term=reverse cterm=NONE ctermbg=31 ctermfg=16 gui=NONE guibg=#00ffff guifg=#000000
    CSAHi MoreMsg term=bold cterm=bold ctermbg=16 ctermfg=31 gui=bold guibg=#000000 guifg=#00ffff
    CSAHi ModeMsg term=bold cterm=bold ctermbg=16 ctermfg=31 gui=bold guibg=#000000 guifg=#00ffff
    CSAHi LineNr term=underline cterm=NONE ctermbg=16 ctermfg=21 gui=NONE guibg=#000000 guifg=#008888
    ...
    CSAHi TabLineSel term=bold cterm=NONE ctermbg=21 ctermfg=16 gui=NONE guibg=#00aaaa guifg=#000000
    ...
    CSAHi cDefine term=NONE cterm=NONE ctermbg=bg ctermfg=31 gui=NONE guibg=bg guifg=#00ffff
    CSAHi Question term=NONE cterm=bold ctermbg=bg ctermfg=31 gui=bold guibg=bg guifg=#00ffff
    CSAHi StatusLine term=reverse,bold cterm=NONE ctermbg=31 ctermfg=16 gui=NONE guibg=#00ffff guifg=#000000
    ...
    CSAHi Title term=bold cterm=NONE ctermbg=bg ctermfg=31 gui=NONE guibg=bg guifg=#00ffff
    CSAHi Visual term=reverse cterm=NONE ctermbg=26 ctermfg=16 gui=NONE guibg=#00dddd guifg=#000000
    CSAHi VisualNOS term=bold,underline cterm=bold,underline ctermbg=bg ctermfg=fg gui=bold,underline guibg=bg guifg=fg
    ...
    CSAHi MatchParen term=reverse cterm=NONE ctermbg=80 ctermfg=31 gui=NONE guibg=#222222 guifg=#00ffff
    ...
    CSAHi Identifier term=underline cterm=NONE ctermbg=16 ctermfg=26 gui=NONE guibg=#000000 guifg=#00cccc
    ...
    CSAHi DiffAdd term=bold cterm=NONE ctermbg=80 ctermfg=31 gui=NONE guibg=#333333 guifg=#00ffff
    CSAHi DiffChange term=bold cterm=NONE ctermbg=80 ctermfg=31 gui=NONE guibg=#333333 guifg=#00ffff
    CSAHi DiffDelete term=bold cterm=bold ctermbg=80 ctermfg=31 gui=bold guibg=#333333 guifg=#00ffff
