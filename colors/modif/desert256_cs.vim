...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsole) || &term =~? "^konsole"
    ...
    CSAHi NonText term=bold cterm=bold ctermbg=16 ctermfg=153 gui=bold guibg=#000000 guifg=#addbe7
    ...
    CSAHi StatusLine term=reverse,bold cterm=NONE ctermbg=187 ctermfg=16 gui=reverse guibg=#000000 guifg=#c2bfa5
    CSAHi StatusLineNC term=reverse cterm=NONE ctermbg=187 ctermfg=244 gui=reverse guibg=#7f7f7f guifg=#c2bfa5
    CSAHi VertSplit term=reverse cterm=NONE ctermbg=187 ctermfg=244 gui=reverse guibg=#7f7f7f guifg=#c2bfa5
    CSAHi Title term=bold cterm=bold ctermbg=bg ctermfg=174 gui=bold guibg=bg guifg=#cd5c5c
    CSAHi Visual term=reverse cterm=NONE ctermbg=107 ctermfg=229 gui=reverse guibg=#f0e68c guifg=#6b8e23
...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_eterm") && g:CSApprox_eterm) || &term =~? "^eterm"
    ...
    CSAHi NonText term=bold cterm=bold ctermbg=16 ctermfg=195 gui=bold guibg=#000000 guifg=#addbe7
    CSAHi Directory term=bold cterm=NONE ctermbg=bg ctermfg=21 gui=NONE guibg=bg guifg=Blue
    ...
    CSAHi StatusLine term=reverse,bold cterm=NONE ctermbg=224 ctermfg=16 gui=reverse guibg=#000000 guifg=#c2bfa5
    CSAHi StatusLineNC term=reverse cterm=NONE ctermbg=224 ctermfg=145 gui=reverse guibg=#7f7f7f guifg=#c2bfa5
    CSAHi VertSplit term=reverse cterm=NONE ctermbg=224 ctermfg=145 gui=reverse guibg=#7f7f7f guifg=#c2bfa5
    CSAHi Title term=bold cterm=bold ctermbg=bg ctermfg=210 gui=bold guibg=bg guifg=#cd5c5c
    CSAHi Visual term=reverse cterm=NONE ctermbg=143 ctermfg=229 gui=reverse guibg=#f0e68c guifg=#6b8e23
    CSAHi VisualNOS term=bold,underline cterm=bold,underline ctermbg=bg ctermfg=fg gui=bold,underline guibg=bg guifg=fg
...
elseif has("gui_running") || &t_Co == 256
    ...
    CSAHi NonText term=bold cterm=bold ctermbg=16 ctermfg=152 gui=bold guibg=#000000 guifg=#addbe7
    CSAHi Directory term=bold cterm=NONE ctermbg=bg ctermfg=21 gui=NONE guibg=bg guifg=Blue
    CSAHi ErrorMsg term=NONE cterm=NONE ctermbg=196 ctermfg=231 gui=NONE guibg=Red guifg=White
    ...
    CSAHi Question term=NONE cterm=bold ctermbg=bg ctermfg=48 gui=bold guibg=bg guifg=#00ff7f
    CSAHi StatusLine term=reverse,bold cterm=NONE ctermbg=145 ctermfg=16 gui=reverse guibg=#000000 guifg=#c2bfa5
    CSAHi StatusLineNC term=reverse cterm=NONE ctermbg=145 ctermfg=244 gui=reverse guibg=#7f7f7f guifg=#c2bfa5
    CSAHi VertSplit term=reverse cterm=NONE ctermbg=145 ctermfg=244 gui=reverse guibg=#7f7f7f guifg=#c2bfa5
    CSAHi Title term=bold cterm=bold ctermbg=bg ctermfg=167 gui=bold guibg=bg guifg=#cd5c5c
    CSAHi Visual term=reverse cterm=NONE ctermbg=64 ctermfg=222 gui=reverse guibg=#f0e68c guifg=#6b8e23
    CSAHi VisualNOS term=bold,underline cterm=bold,underline ctermbg=bg ctermfg=fg gui=bold,underline guibg=bg guifg=fg
...
elseif has("gui_running") || &t_Co == 88
    ...
    CSAHi NonText term=bold cterm=bold ctermbg=16 ctermfg=59 gui=bold guibg=#000000 guifg=#addbe7
    ...
    CSAHi StatusLine term=reverse,bold cterm=NONE ctermbg=57 ctermfg=16 gui=reverse guibg=#000000 guifg=#c2bfa5
    CSAHi StatusLineNC term=reverse cterm=NONE ctermbg=57 ctermfg=82 gui=reverse guibg=#7f7f7f guifg=#c2bfa5
    CSAHi VertSplit term=reverse cterm=NONE ctermbg=57 ctermfg=82 gui=reverse guibg=#7f7f7f guifg=#c2bfa5
    CSAHi Title term=bold cterm=bold ctermbg=bg ctermfg=53 gui=bold guibg=bg guifg=#cd5c5c
    CSAHi Visual term=reverse cterm=NONE ctermbg=36 ctermfg=73 gui=reverse guibg=#f0e68c guifg=#6b8e23
    CSAHi VisualNOS term=bold,underline cterm=bold,underline ctermbg=bg ctermfg=fg gui=bold,underline guibg=bg guifg=fg
