...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsole) || &term =~? "^konsole"
    CSAHi Normal term=NONE cterm=NONE ctermbg=238 ctermfg=253 gui=NONE guibg=gray25 guifg=gray85
    CSAHi Underlined term=underline cterm=underline ctermbg=bg ctermfg=147 gui=underline guibg=bg guifg=#80a0ff
    CSAHi Ignore term=NONE cterm=NONE ctermbg=bg ctermfg=238 gui=NONE guibg=bg guifg=bg
    ...
    CSAHi NonText term=bold cterm=bold ctermbg=bg ctermfg=248 gui=bold guibg=bg guifg=DarkGray
    ...
    CSAHi Cursor term=NONE cterm=NONE ctermbg=160 ctermfg=238 gui=NONE guibg=red3 guifg=bg
    CSAHi Tags term=NONE cterm=NONE ctermbg=bg ctermfg=214 gui=NONE guibg=bg guifg=orange1
    ...
    CSAHi lCursor term=NONE cterm=NONE ctermbg=253 ctermfg=238 gui=NONE guibg=fg guifg=bg
    CSAHi MatchParen term=reverse cterm=NONE ctermbg=51 ctermfg=fg gui=NONE guibg=Cyan guifg=fg
    CSAHi Comment term=bold cterm=NONE ctermbg=bg ctermfg=224 gui=NONE guibg=bg guifg=LightPink
    CSAHi Constant term=underline cterm=NONE ctermbg=bg ctermfg=48 gui=NONE guibg=bg guifg=SpringGreen
    ...
    CSAHi Statement term=bold cterm=bold ctermbg=bg ctermfg=153 gui=bold guibg=bg guifg=SkyBlue
    CSAHi PreProc term=underline cterm=NONE ctermbg=bg ctermfg=153 gui=NONE guibg=bg guifg=SkyBlue
    CSAHi Type term=underline cterm=bold ctermbg=bg ctermfg=153 gui=bold guibg=bg guifg=SkyBlue
...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_eterm") && g:CSApprox_eterm) || &term =~? "^eterm"
    ...
    CSAHi CursorColumn term=reverse cterm=NONE ctermbg=254 ctermfg=fg gui=NONE guibg=Grey90 guifg=fg
    CSAHi CursorLine term=underline cterm=NONE ctermbg=254 ctermfg=fg gui=NONE guibg=Grey90 guifg=fg
    CSAHi Cursor term=NONE cterm=NONE ctermbg=196 ctermfg=238 gui=NONE guibg=red3 guifg=bg
    CSAHi Tags term=NONE cterm=NONE ctermbg=bg ctermfg=220 gui=NONE guibg=bg guifg=orange1
    CSAHi Question term=NONE cterm=bold ctermbg=bg ctermfg=72 gui=bold guibg=bg guifg=SeaGreen
    CSAHi StatusLine term=reverse,bold cterm=bold ctermbg=253 ctermfg=238 gui=reverse,bold guibg=bg guifg=fg
    CSAHi StatusLineNC term=reverse cterm=NONE ctermbg=253 ctermfg=238 gui=reverse guibg=bg guifg=fg
    CSAHi VertSplit term=reverse cterm=NONE ctermbg=253 ctermfg=238 gui=reverse guibg=bg guifg=fg
    ...
    CSAHi lCursor term=NONE cterm=NONE ctermbg=253 ctermfg=238 gui=NONE guibg=fg guifg=bg
    CSAHi MatchParen term=reverse cterm=NONE ctermbg=51 ctermfg=fg gui=NONE guibg=Cyan guifg=fg
    CSAHi Comment term=bold cterm=NONE ctermbg=bg ctermfg=225 gui=NONE guibg=bg guifg=LightPink
    CSAHi Constant term=underline cterm=NONE ctermbg=bg ctermfg=49 gui=NONE guibg=bg guifg=SpringGreen
    ...
    CSAHi Statement term=bold cterm=bold ctermbg=bg ctermfg=159 gui=bold guibg=bg guifg=SkyBlue
    CSAHi PreProc term=underline cterm=NONE ctermbg=bg ctermfg=159 gui=NONE guibg=bg guifg=SkyBlue
    CSAHi Type term=underline cterm=bold ctermbg=bg ctermfg=159 gui=bold guibg=bg guifg=SkyBlue
    CSAHi FoldColumn term=NONE cterm=NONE ctermbg=250 ctermfg=19 gui=NONE guibg=Grey guifg=DarkBlue
...
elseif has("gui_running") || &t_Co == 256
    ...
    CSAHi lCursor term=NONE cterm=NONE ctermbg=253 ctermfg=238 gui=NONE guibg=fg guifg=bg
    CSAHi MatchParen term=reverse cterm=NONE ctermbg=51 ctermfg=fg gui=NONE guibg=Cyan guifg=fg
    CSAHi Comment term=bold cterm=NONE ctermbg=bg ctermfg=217 gui=NONE guibg=bg guifg=LightPink
    CSAHi Constant term=underline cterm=NONE ctermbg=bg ctermfg=48 gui=NONE guibg=bg guifg=SpringGreen
    CSAHi Special term=bold cterm=NONE ctermbg=bg ctermfg=214 gui=NONE guibg=bg guifg=Orange
    CSAHi Identifier term=underline cterm=NONE ctermbg=bg ctermfg=87 gui=NONE guibg=bg guifg=#40ffff
    CSAHi Statement term=bold cterm=bold ctermbg=bg ctermfg=116 gui=bold guibg=bg guifg=SkyBlue
    CSAHi PreProc term=underline cterm=NONE ctermbg=bg ctermfg=116 gui=NONE guibg=bg guifg=SkyBlue
    CSAHi Type term=underline cterm=bold ctermbg=bg ctermfg=116 gui=bold guibg=bg guifg=SkyBlue
...
elseif has("gui_running") || &t_Co == 88
    CSAHi Normal term=NONE cterm=NONE ctermbg=80 ctermfg=86 gui=NONE guibg=gray25 guifg=gray85
    ...
    CSAHi NonText term=bold cterm=bold ctermbg=bg ctermfg=84 gui=bold guibg=bg guifg=DarkGray
    ...
    CSAHi Cursor term=NONE cterm=NONE ctermbg=48 ctermfg=80 gui=NONE guibg=red3 guifg=bg
    CSAHi Tags term=NONE cterm=NONE ctermbg=bg ctermfg=68 gui=NONE guibg=bg guifg=orange1
    ...
    CSAHi Comment term=bold cterm=NONE ctermbg=bg ctermfg=74 gui=NONE guibg=bg guifg=LightPink
    CSAHi Constant term=underline cterm=NONE ctermbg=bg ctermfg=29 gui=NONE guibg=bg guifg=SpringGreen
    ...
    CSAHi Statement term=bold cterm=bold ctermbg=bg ctermfg=43 gui=bold guibg=bg guifg=SkyBlue
    CSAHi PreProc term=underline cterm=NONE ctermbg=bg ctermfg=43 gui=NONE guibg=bg guifg=SkyBlue
    CSAHi Type term=underline cterm=bold ctermbg=bg ctermfg=43 gui=bold guibg=bg guifg=SkyBlue
