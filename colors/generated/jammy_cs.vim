...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsole) || &term =~? "^konsole"
    ...
    CSAHi NonText term=bold cterm=bold ctermbg=16 ctermfg=153 gui=bold guibg=black guifg=LightBlue
    ...
    CSAHi Visual term=reverse cterm=NONE ctermbg=239 ctermfg=fg gui=NONE guibg=grey30 guifg=fg
    ...
    CSAHi Comment term=bold cterm=NONE ctermbg=bg ctermfg=145 gui=NONE guibg=bg guifg=grey60
    CSAHi Constant term=underline cterm=NONE ctermbg=bg ctermfg=174 gui=NONE guibg=bg guifg=indianred
    ...
    CSAHi Statement term=bold cterm=bold ctermbg=bg ctermfg=222 gui=bold guibg=bg guifg=#E6DB74
...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_eterm") && g:CSApprox_eterm) || &term =~? "^eterm"
    ...
    CSAHi NonText term=bold cterm=bold ctermbg=16 ctermfg=195 gui=bold guibg=black guifg=LightBlue
    CSAHi Directory term=bold cterm=NONE ctermbg=bg ctermfg=21 gui=NONE guibg=bg guifg=Blue
    ...
    CSAHi MatchParen term=reverse cterm=NONE ctermbg=51 ctermfg=fg gui=NONE guibg=Cyan guifg=fg
    CSAHi Comment term=bold cterm=NONE ctermbg=bg ctermfg=246 gui=NONE guibg=bg guifg=grey60
    CSAHi Constant term=underline cterm=NONE ctermbg=bg ctermfg=210 gui=NONE guibg=bg guifg=indianred
    ...
    CSAHi Statement term=bold cterm=bold ctermbg=bg ctermfg=229 gui=bold guibg=bg guifg=#E6DB74
...
elseif has("gui_running") || &t_Co == 256
    ...
    CSAHi NonText term=bold cterm=bold ctermbg=16 ctermfg=152 gui=bold guibg=black guifg=LightBlue
    CSAHi Directory term=bold cterm=NONE ctermbg=bg ctermfg=21 gui=NONE guibg=bg guifg=Blue
    CSAHi ErrorMsg term=NONE cterm=NONE ctermbg=196 ctermfg=231 gui=NONE guibg=Red guifg=White
    ...
    CSAHi MatchParen term=reverse cterm=NONE ctermbg=51 ctermfg=fg gui=NONE guibg=Cyan guifg=fg
    CSAHi Comment term=bold cterm=NONE ctermbg=bg ctermfg=246 gui=NONE guibg=bg guifg=grey60
    CSAHi Constant term=underline cterm=NONE ctermbg=bg ctermfg=167 gui=NONE guibg=bg guifg=indianred
    CSAHi Special term=bold cterm=NONE ctermbg=bg ctermfg=223 gui=NONE guibg=bg guifg=navajowhite
    CSAHi Identifier term=underline cterm=NONE ctermbg=bg ctermfg=120 gui=NONE guibg=bg guifg=palegreen
    CSAHi Statement term=bold cterm=bold ctermbg=bg ctermfg=186 gui=bold guibg=bg guifg=#E6DB74
...
elseif has("gui_running") || &t_Co == 88
    ...
    CSAHi NonText term=bold cterm=bold ctermbg=16 ctermfg=58 gui=bold guibg=black guifg=LightBlue
    ...
    CSAHi Visual term=reverse cterm=NONE ctermbg=81 ctermfg=fg gui=NONE guibg=grey30 guifg=fg
    CSAHi VisualNOS term=bold,underline cterm=bold,underline ctermbg=bg ctermfg=fg gui=bold,underline guibg=bg guifg=fg
    ...
    CSAHi Comment term=bold cterm=NONE ctermbg=bg ctermfg=84 gui=NONE guibg=bg guifg=grey60
    CSAHi Constant term=underline cterm=NONE ctermbg=bg ctermfg=53 gui=NONE guibg=bg guifg=indianred
    ...
    CSAHi Statement term=bold cterm=bold ctermbg=bg ctermfg=57 gui=bold guibg=bg guifg=#E6DB74
