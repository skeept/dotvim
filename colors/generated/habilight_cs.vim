...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsole) || &term =~? "^konsole"
    ...
    CSAHi MatchParen term=reverse cterm=bold ctermbg=194 ctermfg=16 gui=bold guibg=#B5EEB5 guifg=black
    CSAHi Comment term=bold cterm=NONE ctermbg=bg ctermfg=37 gui=NONE guibg=bg guifg=darkcyan
    ...
    CSAHi SpellLocale term=underline cterm=undercurl ctermbg=bg ctermfg=37 gui=undercurl guibg=bg guifg=fg guisp=DarkCyan
    CSAHi KDE term=NONE cterm=NONE ctermbg=bg ctermfg=201 gui=NONE guibg=bg guifg=magenta
    CSAHi Tag term=bold cterm=NONE ctermbg=bg ctermfg=28 gui=NONE guibg=bg guifg=DarkGreen
    CSAHi mySpecialSymbols term=NONE cterm=NONE ctermbg=bg ctermfg=201 gui=NONE guibg=bg guifg=magenta
...
elseif has("gui_running") || &t_Co == 256
    ...
    CSAHi lCursor term=NONE cterm=NONE ctermbg=16 ctermfg=231 gui=NONE guibg=fg guifg=bg
    CSAHi MatchParen term=reverse cterm=bold ctermbg=157 ctermfg=16 gui=bold guibg=#B5EEB5 guifg=black
    CSAHi Comment term=bold cterm=NONE ctermbg=bg ctermfg=30 gui=NONE guibg=bg guifg=darkcyan
    ...
    CSAHi Type term=underline cterm=NONE ctermbg=bg ctermfg=21 gui=NONE guibg=bg guifg=Blue
    CSAHi SpellLocale term=underline cterm=undercurl ctermbg=bg ctermfg=30 gui=undercurl guibg=bg guifg=fg guisp=DarkCyan
    CSAHi KDE term=NONE cterm=NONE ctermbg=bg ctermfg=201 gui=NONE guibg=bg guifg=magenta
...
elseif has("gui_running") || &t_Co == 88
    ...
    CSAHi MatchParen term=reverse cterm=bold ctermbg=62 ctermfg=16 gui=bold guibg=#B5EEB5 guifg=black
    CSAHi Comment term=bold cterm=NONE ctermbg=bg ctermfg=21 gui=NONE guibg=bg guifg=darkcyan
    ...
    CSAHi SpellLocale term=underline cterm=undercurl ctermbg=bg ctermfg=21 gui=undercurl guibg=bg guifg=fg guisp=DarkCyan
    CSAHi KDE term=NONE cterm=NONE ctermbg=bg ctermfg=67 gui=NONE guibg=bg guifg=magenta
    CSAHi Tag term=bold cterm=NONE ctermbg=bg ctermfg=20 gui=NONE guibg=bg guifg=DarkGreen
    CSAHi mySpecialSymbols term=NONE cterm=NONE ctermbg=bg ctermfg=67 gui=NONE guibg=bg guifg=magenta
