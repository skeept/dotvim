...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsole) || &term =~? "^konsole"
    ...
    CSAHi NonText term=bold cterm=bold ctermbg=bg ctermfg=46 gui=bold guibg=bg guifg=green
    ...
    CSAHi DebugStop term=NONE cterm=NONE ctermbg=157 ctermfg=231 gui=NONE guibg=lightgreen guifg=white
    CSAHi DebugBreak term=NONE cterm=NONE ctermbg=124 ctermfg=231 gui=NONE guibg=darkred guifg=white
    ...
    CSAHi Visual term=reverse cterm=NONE ctermbg=250 ctermfg=16 gui=reverse guibg=black guifg=gray
    ...
    CSAHi Folded term=NONE cterm=NONE ctermbg=16 ctermfg=51 gui=NONE guibg=bg guifg=cyan
    ...
    CSAHi FoldColumn term=NONE cterm=NONE ctermbg=16 ctermfg=51 gui=NONE guibg=bg guifg=cyan
    CSAHi DiffAdd term=bold cterm=NONE ctermbg=16 ctermfg=46 gui=NONE guibg=Black guifg=Green
    CSAHi DiffChange term=bold cterm=NONE ctermbg=21 ctermfg=231 gui=NONE guibg=Blue guifg=White
    CSAHi DiffDelete term=bold cterm=bold ctermbg=16 ctermfg=201 gui=bold guibg=Black guifg=Magenta
    CSAHi DiffText term=reverse cterm=bold ctermbg=196 ctermfg=231 gui=bold guibg=Red guifg=White
...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_eterm") && g:CSApprox_eterm) || &term =~? "^eterm"
    ...
    CSAHi CursorLine term=underline cterm=NONE ctermbg=254 ctermfg=fg gui=NONE guibg=Grey90 guifg=fg
    CSAHi Cursor term=NONE cterm=NONE ctermbg=250 ctermfg=16 gui=NONE guibg=fg guifg=bg
    CSAHi DebugStop term=NONE cterm=NONE ctermbg=157 ctermfg=255 gui=NONE guibg=lightgreen guifg=white
    CSAHi DebugBreak term=NONE cterm=NONE ctermbg=124 ctermfg=255 gui=NONE guibg=darkred guifg=white
    CSAHi Question term=NONE cterm=bold ctermbg=bg ctermfg=46 gui=bold guibg=bg guifg=Green
    CSAHi StatusLine term=reverse,bold cterm=bold ctermbg=250 ctermfg=16 gui=reverse,bold guibg=bg guifg=fg
    CSAHi StatusLineNC term=reverse cterm=NONE ctermbg=250 ctermfg=16 gui=reverse guibg=bg guifg=fg
    CSAHi VertSplit term=reverse cterm=NONE ctermbg=250 ctermfg=16 gui=reverse guibg=bg guifg=fg
    ...
    CSAHi FoldColumn term=NONE cterm=NONE ctermbg=16 ctermfg=51 gui=NONE guibg=bg guifg=cyan
    CSAHi DiffAdd term=bold cterm=NONE ctermbg=16 ctermfg=46 gui=NONE guibg=Black guifg=Green
    CSAHi DiffChange term=bold cterm=NONE ctermbg=21 ctermfg=255 gui=NONE guibg=Blue guifg=White
    CSAHi DiffDelete term=bold cterm=bold ctermbg=16 ctermfg=201 gui=bold guibg=Black guifg=Magenta
    CSAHi DiffText term=reverse cterm=bold ctermbg=196 ctermfg=255 gui=bold guibg=Red guifg=White
    CSAHi SignColumn term=NONE cterm=NONE ctermbg=250 ctermfg=19 gui=NONE guibg=Grey guifg=DarkBlue
    CSAHi SpellBad term=reverse cterm=undercurl ctermbg=bg ctermfg=196 gui=undercurl guibg=bg guifg=fg guisp=Red
    CSAHi SpellCap term=reverse cterm=undercurl ctermbg=bg ctermfg=21 gui=undercurl guibg=bg guifg=fg guisp=Blue
    CSAHi SpellRare term=reverse cterm=undercurl ctermbg=bg ctermfg=201 gui=undercurl guibg=bg guifg=fg guisp=Magenta
...
elseif has("gui_running") || &t_Co == 256
    ...
    CSAHi CursorLine term=underline cterm=NONE ctermbg=254 ctermfg=fg gui=NONE guibg=Grey90 guifg=fg
    CSAHi Cursor term=NONE cterm=NONE ctermbg=250 ctermfg=16 gui=NONE guibg=fg guifg=bg
    CSAHi DebugStop term=NONE cterm=NONE ctermbg=120 ctermfg=231 gui=NONE guibg=lightgreen guifg=white
    CSAHi DebugBreak term=NONE cterm=NONE ctermbg=88 ctermfg=231 gui=NONE guibg=darkred guifg=white
    CSAHi Question term=NONE cterm=bold ctermbg=bg ctermfg=46 gui=bold guibg=bg guifg=Green
    CSAHi StatusLine term=reverse,bold cterm=bold ctermbg=250 ctermfg=16 gui=reverse,bold guibg=bg guifg=fg
    CSAHi StatusLineNC term=reverse cterm=NONE ctermbg=250 ctermfg=16 gui=reverse guibg=bg guifg=fg
    CSAHi VertSplit term=reverse cterm=NONE ctermbg=250 ctermfg=16 gui=reverse guibg=bg guifg=fg
...
elseif has("gui_running") || &t_Co == 88
    ...
    CSAHi NonText term=bold cterm=bold ctermbg=bg ctermfg=28 gui=bold guibg=bg guifg=green
    ...
    CSAHi DebugStop term=NONE cterm=NONE ctermbg=45 ctermfg=79 gui=NONE guibg=lightgreen guifg=white
    CSAHi DebugBreak term=NONE cterm=NONE ctermbg=32 ctermfg=79 gui=NONE guibg=darkred guifg=white
    ...
    CSAHi Visual term=reverse cterm=NONE ctermbg=85 ctermfg=16 gui=reverse guibg=black guifg=gray
    CSAHi VisualNOS term=bold,underline cterm=bold,underline ctermbg=bg ctermfg=fg gui=bold,underline guibg=bg guifg=fg
    CSAHi WarningMsg term=NONE cterm=NONE ctermbg=bg ctermfg=64 gui=NONE guibg=bg guifg=Red
    CSAHi WildMenu term=NONE cterm=NONE ctermbg=76 ctermfg=16 gui=NONE guibg=Yellow guifg=Black
    CSAHi Folded term=NONE cterm=NONE ctermbg=16 ctermfg=31 gui=NONE guibg=bg guifg=cyan
    ...
    CSAHi FoldColumn term=NONE cterm=NONE ctermbg=16 ctermfg=31 gui=NONE guibg=bg guifg=cyan
    CSAHi DiffAdd term=bold cterm=NONE ctermbg=16 ctermfg=28 gui=NONE guibg=Black guifg=Green
    CSAHi DiffChange term=bold cterm=NONE ctermbg=19 ctermfg=79 gui=NONE guibg=Blue guifg=White
    CSAHi DiffDelete term=bold cterm=bold ctermbg=16 ctermfg=67 gui=bold guibg=Black guifg=Magenta
    CSAHi DiffText term=reverse cterm=bold ctermbg=64 ctermfg=79 gui=bold guibg=Red guifg=White
