...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsole) || &term =~? "^konsole"
    CSAHi Normal term=NONE cterm=NONE ctermbg=16 ctermfg=147 gui=NONE guibg=Black guifg=#a0a0ff
    ...
    CSAHi String term=underline cterm=NONE ctermbg=bg ctermfg=217 gui=NONE guibg=bg guifg=#ffa0a0
    ...
    CSAHi Repeat term=underline cterm=NONE ctermbg=bg ctermfg=196 gui=NONE guibg=bg guifg=Red
    CSAHi Label term=NONE cterm=NONE ctermbg=bg ctermfg=184 gui=NONE guibg=bg guifg=DarkYellow
    CSAHi Operator term=NONE cterm=NONE ctermbg=bg ctermfg=210 gui=NONE guibg=bg guifg=#ff5555
    CSAHi Keyword term=NONE cterm=NONE ctermbg=bg ctermfg=46 gui=NONE guibg=bg guifg=Green
    CSAHi Exception term=NONE cterm=NONE ctermbg=bg ctermfg=200 gui=NONE guibg=bg guifg=#ff0dd5
    CSAHi Question term=NONE cterm=bold ctermbg=bg ctermfg=51 gui=bold guibg=bg guifg=Cyan
    CSAHi StatusLine term=reverse,bold cterm=NONE ctermbg=19 ctermfg=231 gui=NONE guibg=darkblue guifg=White
    CSAHi StatusLineNC term=reverse cterm=NONE ctermbg=59 ctermfg=231 gui=NONE guibg=#333333 guifg=white
    ...
    CSAHi PreProc term=underline cterm=NONE ctermbg=bg ctermfg=224 gui=NONE guibg=bg guifg=Wheat
    CSAHi Type term=underline cterm=NONE ctermbg=bg ctermfg=250 gui=NONE guibg=bg guifg=grey
    CSAHi Tag term=NONE cterm=NONE ctermbg=bg ctermfg=118 gui=NONE guibg=bg guifg=#55ff0d
    CSAHi Delimiter term=NONE cterm=NONE ctermbg=bg ctermfg=49 gui=NONE guibg=bg guifg=#00ff88
...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_eterm") && g:CSApprox_eterm) || &term =~? "^eterm"
    CSAHi Normal term=NONE cterm=NONE ctermbg=16 ctermfg=189 gui=NONE guibg=Black guifg=#a0a0ff
    CSAHi Underlined term=underline cterm=underline ctermbg=bg ctermfg=153 gui=underline guibg=bg guifg=#80a0ff
    CSAHi Ignore term=NONE cterm=NONE ctermbg=bg ctermfg=16 gui=NONE guibg=bg guifg=bg
    CSAHi Error term=reverse cterm=NONE ctermbg=196 ctermfg=255 gui=NONE guibg=Red guifg=White
    CSAHi Todo term=NONE cterm=NONE ctermbg=226 ctermfg=21 gui=NONE guibg=Yellow guifg=Blue
    CSAHi String term=underline cterm=NONE ctermbg=bg ctermfg=224 gui=NONE guibg=bg guifg=#ffa0a0
    CSAHi SpecialKey term=bold cterm=NONE ctermbg=bg ctermfg=51 gui=NONE guibg=bg guifg=Cyan
    CSAHi NonText term=bold cterm=bold ctermbg=bg ctermfg=21 gui=bold guibg=bg guifg=Blue
    CSAHi Directory term=bold cterm=NONE ctermbg=bg ctermfg=51 gui=NONE guibg=bg guifg=Cyan
    ...
    CSAHi Operator term=NONE cterm=NONE ctermbg=bg ctermfg=210 gui=NONE guibg=bg guifg=#ff5555
    CSAHi Keyword term=NONE cterm=NONE ctermbg=bg ctermfg=46 gui=NONE guibg=bg guifg=Green
    CSAHi Exception term=NONE cterm=NONE ctermbg=bg ctermfg=201 gui=NONE guibg=bg guifg=#ff0dd5
    CSAHi Question term=NONE cterm=bold ctermbg=bg ctermfg=51 gui=bold guibg=bg guifg=Cyan
    CSAHi StatusLine term=reverse,bold cterm=NONE ctermbg=19 ctermfg=255 gui=NONE guibg=darkblue guifg=White
    CSAHi StatusLineNC term=reverse cterm=NONE ctermbg=236 ctermfg=255 gui=NONE guibg=#333333 guifg=white
    ...
    CSAHi MatchParen term=reverse cterm=NONE ctermbg=51 ctermfg=fg gui=NONE guibg=Cyan guifg=fg
    CSAHi Comment term=bold cterm=NONE ctermbg=bg ctermfg=220 gui=NONE guibg=bg guifg=Orange
    CSAHi Constant term=underline cterm=NONE ctermbg=bg ctermfg=255 gui=NONE guibg=bg guifg=White
    CSAHi Special term=bold cterm=NONE ctermbg=bg ctermfg=201 gui=NONE guibg=bg guifg=magenta
    CSAHi Identifier term=underline cterm=NONE ctermbg=bg ctermfg=51 gui=NONE guibg=bg guifg=#00ffff
    CSAHi Statement term=bold cterm=NONE ctermbg=bg ctermfg=226 gui=NONE guibg=bg guifg=#ffff00
    CSAHi PreProc term=underline cterm=NONE ctermbg=bg ctermfg=230 gui=NONE guibg=bg guifg=Wheat
    CSAHi Type term=underline cterm=NONE ctermbg=bg ctermfg=250 gui=NONE guibg=bg guifg=grey
    CSAHi Tag term=NONE cterm=NONE ctermbg=bg ctermfg=118 gui=NONE guibg=bg guifg=#55ff0d
    CSAHi Delimiter term=NONE cterm=NONE ctermbg=bg ctermfg=49 gui=NONE guibg=bg guifg=#00ff88
    CSAHi FoldColumn term=NONE cterm=NONE ctermbg=250 ctermfg=19 gui=NONE guibg=Grey guifg=DarkBlue
...
elseif has("gui_running") || &t_Co == 256
    ...
    CSAHi Menu term=NONE cterm=NONE ctermbg=51 ctermfg=16 gui=NONE guibg=cyan guifg=black
    CSAHi Repeat term=underline cterm=NONE ctermbg=bg ctermfg=196 gui=NONE guibg=bg guifg=Red
    CSAHi Label term=NONE cterm=NONE ctermbg=bg ctermfg=142 gui=NONE guibg=bg guifg=DarkYellow
    CSAHi Operator term=NONE cterm=NONE ctermbg=bg ctermfg=203 gui=NONE guibg=bg guifg=#ff5555
    CSAHi Keyword term=NONE cterm=NONE ctermbg=bg ctermfg=46 gui=NONE guibg=bg guifg=Green
    CSAHi Exception term=NONE cterm=NONE ctermbg=bg ctermfg=200 gui=NONE guibg=bg guifg=#ff0dd5
    CSAHi Question term=NONE cterm=bold ctermbg=bg ctermfg=51 gui=bold guibg=bg guifg=Cyan
    ...
    CSAHi Type term=underline cterm=NONE ctermbg=bg ctermfg=250 gui=NONE guibg=bg guifg=grey
    CSAHi Tag term=NONE cterm=NONE ctermbg=bg ctermfg=82 gui=NONE guibg=bg guifg=#55ff0d
    CSAHi Delimiter term=NONE cterm=NONE ctermbg=bg ctermfg=48 gui=NONE guibg=bg guifg=#00ff88
...
elseif has("gui_running") || &t_Co == 88
    CSAHi Normal term=NONE cterm=NONE ctermbg=16 ctermfg=39 gui=NONE guibg=Black guifg=#a0a0ff
    ...
    CSAHi String term=underline cterm=NONE ctermbg=bg ctermfg=69 gui=NONE guibg=bg guifg=#ffa0a0
    ...
    CSAHi IncSearch term=reverse cterm=NONE ctermbg=39 ctermfg=16 gui=reverse guibg=bg guifg=fg
    ...
    CSAHi PmenuThumb term=NONE cterm=NONE ctermbg=39 ctermfg=16 gui=reverse guibg=bg guifg=fg
    CSAHi TabLine term=underline cterm=underline ctermbg=86 ctermfg=fg gui=underline guibg=LightGrey guifg=fg
    CSAHi TabLineSel term=bold cterm=bold ctermbg=bg ctermfg=fg gui=bold guibg=bg guifg=fg
    CSAHi TabLineFill term=reverse cterm=NONE ctermbg=39 ctermfg=16 gui=reverse guibg=bg guifg=fg
    ...
    CSAHi Repeat term=underline cterm=NONE ctermbg=bg ctermfg=64 gui=NONE guibg=bg guifg=Red
    CSAHi Label term=NONE cterm=NONE ctermbg=bg ctermfg=56 gui=NONE guibg=bg guifg=DarkYellow
    CSAHi Operator term=NONE cterm=NONE ctermbg=bg ctermfg=69 gui=NONE guibg=bg guifg=#ff5555
    CSAHi Keyword term=NONE cterm=NONE ctermbg=bg ctermfg=28 gui=NONE guibg=bg guifg=Green
    CSAHi Exception term=NONE cterm=NONE ctermbg=bg ctermfg=66 gui=NONE guibg=bg guifg=#ff0dd5
    ...
    CSAHi VertSplit term=reverse cterm=NONE ctermbg=39 ctermfg=16 gui=reverse guibg=bg guifg=fg
    ...
    CSAHi lCursor term=NONE cterm=NONE ctermbg=39 ctermfg=16 gui=NONE guibg=fg guifg=bg
    ...
    CSAHi Tag term=NONE cterm=NONE ctermbg=bg ctermfg=44 gui=NONE guibg=bg guifg=#55ff0d
    CSAHi Delimiter term=NONE cterm=NONE ctermbg=bg ctermfg=29 gui=NONE guibg=bg guifg=#00ff88
