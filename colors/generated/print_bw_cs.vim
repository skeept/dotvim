...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsole) || &term =~? "^konsole"
    ...
    CSAHi Error term=reverse cterm=bold ctermbg=16 ctermfg=250 gui=reverse,bold guibg=grey guifg=black
    CSAHi Todo term=NONE cterm=bold ctermbg=231 ctermfg=16 gui=bold,italic guibg=white guifg=black
    CSAHi String term=NONE cterm=NONE ctermbg=231 ctermfg=16 gui=NONE guibg=white guifg=black
    CSAHi Character term=NONE cterm=NONE ctermbg=231 ctermfg=16 gui=NONE guibg=white guifg=black
    CSAHi Number term=NONE cterm=NONE ctermbg=231 ctermfg=16 gui=NONE guibg=white guifg=black
    CSAHi Float term=NONE cterm=NONE ctermbg=231 ctermfg=16 gui=NONE guibg=white guifg=black
    CSAHi Function term=NONE cterm=NONE ctermbg=231 ctermfg=16 gui=NONE guibg=white guifg=black
    CSAHi SpecialKey term=bold cterm=NONE ctermbg=bg ctermfg=21 gui=NONE guibg=bg guifg=Blue
    CSAHi NonText term=bold cterm=bold ctermbg=231 ctermfg=16 gui=bold guibg=white guifg=black
    ...
    CSAHi LineNr term=underline cterm=NONE ctermbg=231 ctermfg=16 gui=italic guibg=white guifg=black
    ...
    CSAHi Conditional term=NONE cterm=NONE ctermbg=231 ctermfg=16 gui=NONE guibg=white guifg=black
    CSAHi Repeat term=NONE cterm=NONE ctermbg=231 ctermfg=16 gui=NONE guibg=white guifg=black
    CSAHi Label term=NONE cterm=NONE ctermbg=231 ctermfg=16 gui=NONE guibg=white guifg=black
    CSAHi Operator term=NONE cterm=NONE ctermbg=231 ctermfg=16 gui=NONE guibg=white guifg=black
    ...
    CSAHi Comment term=bold cterm=NONE ctermbg=231 ctermfg=16 gui=italic guibg=white guifg=black
    CSAHi Constant term=underline cterm=NONE ctermbg=231 ctermfg=16 gui=NONE guibg=white guifg=black
    CSAHi Special term=bold cterm=NONE ctermbg=231 ctermfg=16 gui=italic guibg=white guifg=black
    CSAHi Identifier term=underline cterm=NONE ctermbg=231 ctermfg=16 gui=NONE guibg=white guifg=black
    CSAHi Statement term=bold cterm=bold ctermbg=231 ctermfg=16 gui=bold guibg=white guifg=black
    CSAHi PreProc term=underline cterm=bold ctermbg=231 ctermfg=16 gui=bold guibg=white guifg=black
    CSAHi Type term=underline cterm=bold ctermbg=231 ctermfg=16 gui=bold guibg=white guifg=black
    CSAHi SpecialComment term=NONE cterm=NONE ctermbg=231 ctermfg=16 gui=italic guibg=white guifg=black
...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_eterm") && g:CSApprox_eterm) || &term =~? "^eterm"
    ...
    CSAHi Error term=reverse cterm=bold ctermbg=16 ctermfg=250 gui=reverse,bold guibg=grey guifg=black
    CSAHi Todo term=NONE cterm=bold ctermbg=255 ctermfg=16 gui=bold,italic guibg=white guifg=black
    CSAHi String term=NONE cterm=NONE ctermbg=255 ctermfg=16 gui=NONE guibg=white guifg=black
    CSAHi Character term=NONE cterm=NONE ctermbg=255 ctermfg=16 gui=NONE guibg=white guifg=black
    CSAHi Number term=NONE cterm=NONE ctermbg=255 ctermfg=16 gui=NONE guibg=white guifg=black
    CSAHi Float term=NONE cterm=NONE ctermbg=255 ctermfg=16 gui=NONE guibg=white guifg=black
    CSAHi Function term=NONE cterm=NONE ctermbg=255 ctermfg=16 gui=NONE guibg=white guifg=black
    CSAHi SpecialKey term=bold cterm=NONE ctermbg=bg ctermfg=21 gui=NONE guibg=bg guifg=Blue
    CSAHi NonText term=bold cterm=bold ctermbg=255 ctermfg=16 gui=bold guibg=white guifg=black
    CSAHi Directory term=bold cterm=NONE ctermbg=bg ctermfg=21 gui=NONE guibg=bg guifg=Blue
    ...
    CSAHi MoreMsg term=bold cterm=bold ctermbg=bg ctermfg=72 gui=bold guibg=bg guifg=SeaGreen
    CSAHi ModeMsg term=bold cterm=bold ctermbg=bg ctermfg=fg gui=bold guibg=bg guifg=fg
    CSAHi LineNr term=underline cterm=NONE ctermbg=255 ctermfg=16 gui=italic guibg=white guifg=black
    CSAHi Pmenu term=NONE cterm=NONE ctermbg=225 ctermfg=fg gui=NONE guibg=LightMagenta guifg=fg
    CSAHi PmenuSel term=NONE cterm=NONE ctermbg=250 ctermfg=fg gui=NONE guibg=Grey guifg=fg
    CSAHi PmenuSbar term=NONE cterm=NONE ctermbg=250 ctermfg=fg gui=NONE guibg=Grey guifg=fg
    ...
    CSAHi Conditional term=NONE cterm=NONE ctermbg=255 ctermfg=16 gui=NONE guibg=white guifg=black
    CSAHi Repeat term=NONE cterm=NONE ctermbg=255 ctermfg=16 gui=NONE guibg=white guifg=black
    CSAHi Label term=NONE cterm=NONE ctermbg=255 ctermfg=16 gui=NONE guibg=white guifg=black
    CSAHi Operator term=NONE cterm=NONE ctermbg=255 ctermfg=16 gui=NONE guibg=white guifg=black
    CSAHi Question term=NONE cterm=bold ctermbg=bg ctermfg=72 gui=bold guibg=bg guifg=SeaGreen
    ...
    CSAHi MatchParen term=reverse cterm=NONE ctermbg=51 ctermfg=fg gui=NONE guibg=Cyan guifg=fg
    CSAHi Comment term=bold cterm=NONE ctermbg=255 ctermfg=16 gui=italic guibg=white guifg=black
    CSAHi Constant term=underline cterm=NONE ctermbg=255 ctermfg=16 gui=NONE guibg=white guifg=black
    CSAHi Special term=bold cterm=NONE ctermbg=255 ctermfg=16 gui=italic guibg=white guifg=black
    CSAHi Identifier term=underline cterm=NONE ctermbg=255 ctermfg=16 gui=NONE guibg=white guifg=black
    CSAHi Statement term=bold cterm=bold ctermbg=255 ctermfg=16 gui=bold guibg=white guifg=black
    CSAHi PreProc term=underline cterm=bold ctermbg=255 ctermfg=16 gui=bold guibg=white guifg=black
    CSAHi Type term=underline cterm=bold ctermbg=255 ctermfg=16 gui=bold guibg=white guifg=black
    CSAHi SpecialComment term=NONE cterm=NONE ctermbg=255 ctermfg=16 gui=italic guibg=white guifg=black
    CSAHi FoldColumn term=NONE cterm=NONE ctermbg=250 ctermfg=19 gui=NONE guibg=Grey guifg=DarkBlue
...
elseif has("gui_running") || &t_Co == 88
    ...
    CSAHi Error term=reverse cterm=bold ctermbg=16 ctermfg=85 gui=reverse,bold guibg=grey guifg=black
    CSAHi Todo term=NONE cterm=bold ctermbg=79 ctermfg=16 gui=bold,italic guibg=white guifg=black
    CSAHi String term=NONE cterm=NONE ctermbg=79 ctermfg=16 gui=NONE guibg=white guifg=black
    CSAHi Character term=NONE cterm=NONE ctermbg=79 ctermfg=16 gui=NONE guibg=white guifg=black
    CSAHi Number term=NONE cterm=NONE ctermbg=79 ctermfg=16 gui=NONE guibg=white guifg=black
    CSAHi Float term=NONE cterm=NONE ctermbg=79 ctermfg=16 gui=NONE guibg=white guifg=black
    CSAHi Function term=NONE cterm=NONE ctermbg=79 ctermfg=16 gui=NONE guibg=white guifg=black
    CSAHi SpecialKey term=bold cterm=NONE ctermbg=bg ctermfg=19 gui=NONE guibg=bg guifg=Blue
    CSAHi NonText term=bold cterm=bold ctermbg=79 ctermfg=16 gui=bold guibg=white guifg=black
    ...
    CSAHi ModeMsg term=bold cterm=bold ctermbg=bg ctermfg=fg gui=bold guibg=bg guifg=fg
    CSAHi LineNr term=underline cterm=NONE ctermbg=79 ctermfg=16 gui=italic guibg=white guifg=black
    ...
    CSAHi Conditional term=NONE cterm=NONE ctermbg=79 ctermfg=16 gui=NONE guibg=white guifg=black
    CSAHi Repeat term=NONE cterm=NONE ctermbg=79 ctermfg=16 gui=NONE guibg=white guifg=black
    CSAHi Label term=NONE cterm=NONE ctermbg=79 ctermfg=16 gui=NONE guibg=white guifg=black
    CSAHi Operator term=NONE cterm=NONE ctermbg=79 ctermfg=16 gui=NONE guibg=white guifg=black
    ...
    CSAHi Comment term=bold cterm=NONE ctermbg=79 ctermfg=16 gui=italic guibg=white guifg=black
    CSAHi Constant term=underline cterm=NONE ctermbg=79 ctermfg=16 gui=NONE guibg=white guifg=black
    CSAHi Special term=bold cterm=NONE ctermbg=79 ctermfg=16 gui=italic guibg=white guifg=black
    CSAHi Identifier term=underline cterm=NONE ctermbg=79 ctermfg=16 gui=NONE guibg=white guifg=black
    CSAHi Statement term=bold cterm=bold ctermbg=79 ctermfg=16 gui=bold guibg=white guifg=black
    CSAHi PreProc term=underline cterm=bold ctermbg=79 ctermfg=16 gui=bold guibg=white guifg=black
    CSAHi Type term=underline cterm=bold ctermbg=79 ctermfg=16 gui=bold guibg=white guifg=black
    CSAHi SpecialComment term=NONE cterm=NONE ctermbg=79 ctermfg=16 gui=italic guibg=white guifg=black
