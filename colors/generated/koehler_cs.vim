...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_eterm") && g:CSApprox_eterm) || &term =~? "^eterm"
    ...
    CSAHi TabLine term=reverse,bold cterm=bold ctermbg=255 ctermfg=21 gui=bold guibg=white guifg=blue
    CSAHi TabLineSel term=reverse cterm=bold ctermbg=21 ctermfg=255 gui=bold guibg=blue guifg=white
    CSAHi TabLineFill term=reverse,bold cterm=bold ctermbg=255 ctermfg=21 gui=bold guibg=white guifg=blue
    ...
    CSAHi Scrollbar term=NONE cterm=NONE ctermbg=51 ctermfg=37 gui=NONE guibg=cyan guifg=darkcyan
    CSAHi Question term=NONE cterm=bold ctermbg=bg ctermfg=46 gui=bold guibg=bg guifg=Green
    CSAHi StatusLine term=reverse,bold cterm=bold ctermbg=255 ctermfg=21 gui=bold guibg=white guifg=blue
    CSAHi StatusLineNC term=reverse cterm=NONE ctermbg=255 ctermfg=21 gui=reverse guibg=blue guifg=white
    CSAHi VertSplit term=reverse cterm=NONE ctermbg=255 ctermfg=16 gui=reverse guibg=bg guifg=fg
    CSAHi Title term=bold cterm=bold ctermbg=bg ctermfg=201 gui=bold guibg=bg guifg=Magenta
    CSAHi Visual term=reverse cterm=NONE ctermbg=255 ctermfg=248 gui=reverse guibg=DarkGrey guifg=fg
    CSAHi VisualNOS term=bold,underline cterm=bold,underline ctermbg=bg ctermfg=fg gui=bold,underline guibg=bg guifg=fg
    CSAHi WarningMsg term=NONE cterm=NONE ctermbg=bg ctermfg=196 gui=NONE guibg=bg guifg=Red
    CSAHi WildMenu term=NONE cterm=NONE ctermbg=226 ctermfg=16 gui=NONE guibg=Yellow guifg=Black
