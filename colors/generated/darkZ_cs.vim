...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsole) || &term =~? "^konsole"
    CSAHi Normal term=NONE cterm=NONE ctermbg=235 ctermfg=188 gui=NONE guibg=gray14 guifg=#DFD6C1
    ...
    CSAHi Function term=NONE cterm=NONE ctermbg=bg ctermfg=155 gui=NONE guibg=bg guifg=#82EF2A
    ...
    CSAHi StatusLine term=reverse,bold cterm=bold ctermbg=224 ctermfg=16 gui=bold guibg=Pink guifg=black
    ...
    CSAHi Identifier term=underline cterm=NONE ctermbg=bg ctermfg=117 gui=NONE guibg=bg guifg=#6FDEF8
    CSAHi Statement term=bold cterm=NONE ctermbg=bg ctermfg=228 gui=NONE guibg=bg guifg=#FCFC63
    CSAHi PreProc term=underline cterm=NONE ctermbg=bg ctermfg=155 gui=NONE guibg=bg guifg=#82EF2A
...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_eterm") && g:CSApprox_eterm) || &term =~? "^eterm"
    CSAHi Normal term=NONE cterm=NONE ctermbg=235 ctermfg=231 gui=NONE guibg=gray14 guifg=#DFD6C1
    ...
    CSAHi StatusLine term=reverse,bold cterm=bold ctermbg=231 ctermfg=16 gui=bold guibg=Pink guifg=black
    ...
    CSAHi Title term=bold cterm=bold ctermbg=bg ctermfg=208 gui=bold guibg=bg guifg=#ff4400
    ...
    CSAHi MatchParen term=reverse cterm=bold ctermbg=242 ctermfg=51 gui=bold guibg=#6C6C6C guifg=cyan
    CSAHi Comment term=bold cterm=NONE ctermbg=bg ctermfg=145 gui=italic guibg=bg guifg=gray50
    CSAHi Constant term=underline cterm=NONE ctermbg=bg ctermfg=219 gui=NONE guibg=bg guifg=#FF77FF
    CSAHi Special term=bold cterm=NONE ctermbg=bg ctermfg=220 gui=NONE guibg=bg guifg=orange
    CSAHi Identifier term=underline cterm=NONE ctermbg=bg ctermfg=159 gui=NONE guibg=bg guifg=#6FDEF8
    CSAHi Statement term=bold cterm=NONE ctermbg=bg ctermfg=228 gui=NONE guibg=bg guifg=#FCFC63
    CSAHi PreProc term=underline cterm=NONE ctermbg=bg ctermfg=155 gui=NONE guibg=bg guifg=#82EF2A
    CSAHi Type term=underline cterm=NONE ctermbg=bg ctermfg=81 gui=NONE guibg=bg guifg=#33AFF3
...
elseif has("gui_running") || &t_Co == 256
    ...
    CSAHi PmenuSbar term=NONE cterm=NONE ctermbg=250 ctermfg=fg gui=NONE guibg=Grey guifg=fg
    CSAHi PmenuThumb term=NONE cterm=NONE ctermbg=187 ctermfg=235 gui=reverse guibg=bg guifg=fg
    CSAHi TabLine term=underline cterm=underline ctermbg=252 ctermfg=fg gui=underline guibg=LightGrey guifg=fg
    CSAHi TabLineSel term=bold cterm=bold ctermbg=bg ctermfg=fg gui=bold guibg=bg guifg=fg
