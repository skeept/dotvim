...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsole) || &term =~? "^konsole"
    CSAHi Normal term=NONE cterm=NONE ctermbg=16 ctermfg=188 gui=NONE guibg=Black guifg=Grey80
    ...
    CSAHi Search term=reverse cterm=NONE ctermbg=19 ctermfg=250 gui=NONE guibg=DarkBlue guifg=Grey
    ...
    CSAHi StatusLine term=reverse,bold cterm=bold ctermbg=238 ctermfg=231 gui=bold guibg=Grey25 guifg=White
    CSAHi StatusLineNC term=reverse cterm=NONE ctermbg=238 ctermfg=252 gui=NONE guibg=Grey25 guifg=LightGrey
    CSAHi VertSplit term=reverse cterm=bold ctermbg=16 ctermfg=238 gui=bold guibg=Black guifg=Grey25
    CSAHi Title term=bold cterm=bold ctermbg=bg ctermfg=201 gui=bold guibg=bg guifg=Magenta
    CSAHi Visual term=reverse cterm=NONE ctermbg=248 ctermfg=16 gui=NONE guibg=DarkGrey guifg=Black
    ...
    CSAHi FoldColumn term=NONE cterm=bold ctermbg=16 ctermfg=231 gui=bold guibg=Black guifg=White
...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_eterm") && g:CSApprox_eterm) || &term =~? "^eterm"
    ...
    CSAHi Question term=NONE cterm=bold ctermbg=bg ctermfg=72 gui=bold guibg=bg guifg=SeaGreen
    CSAHi StatusLine term=reverse,bold cterm=bold ctermbg=238 ctermfg=255 gui=bold guibg=Grey25 guifg=White
    CSAHi StatusLineNC term=reverse cterm=NONE ctermbg=238 ctermfg=231 gui=NONE guibg=Grey25 guifg=LightGrey
    CSAHi VertSplit term=reverse cterm=bold ctermbg=16 ctermfg=238 gui=bold guibg=Black guifg=Grey25
    CSAHi Title term=bold cterm=bold ctermbg=bg ctermfg=201 gui=bold guibg=bg guifg=Magenta
    CSAHi Visual term=reverse cterm=NONE ctermbg=248 ctermfg=16 gui=NONE guibg=DarkGrey guifg=Black
    CSAHi VisualNOS term=bold,underline cterm=bold,underline ctermbg=bg ctermfg=fg gui=bold,underline guibg=bg guifg=fg
    ...
    CSAHi PreProc term=underline cterm=NONE ctermbg=bg ctermfg=219 gui=NONE guibg=bg guifg=#ff80ff
    CSAHi Type term=underline cterm=NONE ctermbg=bg ctermfg=120 gui=NONE guibg=bg guifg=#60ff60
    CSAHi FoldColumn term=NONE cterm=bold ctermbg=16 ctermfg=255 gui=bold guibg=Black guifg=White
...
elseif has("gui_running") || &t_Co == 256
    ...
    CSAHi ErrorMsg term=NONE cterm=NONE ctermbg=196 ctermfg=231 gui=NONE guibg=Red guifg=White
    CSAHi IncSearch term=reverse cterm=NONE ctermbg=252 ctermfg=16 gui=reverse guibg=bg guifg=fg
    CSAHi Search term=reverse cterm=NONE ctermbg=18 ctermfg=250 gui=NONE guibg=DarkBlue guifg=Grey
...
elseif has("gui_running") || &t_Co == 88
    ...
    CSAHi Search term=reverse cterm=NONE ctermbg=17 ctermfg=85 gui=NONE guibg=DarkBlue guifg=Grey
    ...
    CSAHi StatusLine term=reverse,bold cterm=bold ctermbg=80 ctermfg=79 gui=bold guibg=Grey25 guifg=White
    CSAHi StatusLineNC term=reverse cterm=NONE ctermbg=80 ctermfg=86 gui=NONE guibg=Grey25 guifg=LightGrey
    CSAHi VertSplit term=reverse cterm=bold ctermbg=16 ctermfg=80 gui=bold guibg=Black guifg=Grey25
    CSAHi Title term=bold cterm=bold ctermbg=bg ctermfg=67 gui=bold guibg=bg guifg=Magenta
    CSAHi Visual term=reverse cterm=NONE ctermbg=84 ctermfg=16 gui=NONE guibg=DarkGrey guifg=Black
    CSAHi VisualNOS term=bold,underline cterm=bold,underline ctermbg=bg ctermfg=fg gui=bold,underline guibg=bg guifg=fg
    ...
    CSAHi FoldColumn term=NONE cterm=bold ctermbg=16 ctermfg=79 gui=bold guibg=Black guifg=White
