...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsole) || &term =~? "^konsole"
    CSAHi Normal term=NONE cterm=NONE ctermbg=231 ctermfg=238 gui=NONE guibg=#fff4e8 guifg=#404040
    ...
    CSAHi Todo term=NONE cterm=bold,underline ctermbg=bg ctermfg=39 gui=bold,underline guibg=bg guifg=#0080f0
    CSAHi SpecialKey term=bold cterm=NONE ctermbg=bg ctermfg=39 gui=NONE guibg=bg guifg=#0080ff
    CSAHi NonText term=bold cterm=bold ctermbg=224 ctermfg=137 gui=bold guibg=#ffe4d4 guifg=#a05040
    CSAHi Directory term=bold cterm=NONE ctermbg=bg ctermfg=105 gui=NONE guibg=bg guifg=#7050ff
    ...
    CSAHi MoreMsg term=bold cterm=NONE ctermbg=bg ctermfg=37 gui=NONE guibg=bg guifg=#0090a0
    CSAHi ModeMsg term=bold cterm=NONE ctermbg=bg ctermfg=172 gui=NONE guibg=bg guifg=#d06000
    CSAHi LineNr term=underline cterm=NONE ctermbg=bg ctermfg=181 gui=NONE guibg=bg guifg=#e0b090
    ...
    CSAHi Question term=NONE cterm=NONE ctermbg=bg ctermfg=129 gui=NONE guibg=bg guifg=#8000ff
    CSAHi StatusLine term=reverse,bold cterm=bold ctermbg=131 ctermfg=231 gui=bold guibg=#904838 guifg=#f8f8f8
    CSAHi StatusLineNC term=reverse cterm=bold ctermbg=131 ctermfg=181 gui=bold guibg=#904838 guifg=#c0b0a0
    ...
    CSAHi Folded term=NONE cterm=NONE ctermbg=223 ctermfg=131 gui=NONE guibg=#ffc0a0 guifg=#804030
    CSAHi lCursor term=NONE cterm=NONE ctermbg=135 ctermfg=231 gui=NONE guibg=#8040ff guifg=#ffffff
    CSAHi MatchParen term=reverse cterm=NONE ctermbg=51 ctermfg=fg gui=NONE guibg=Cyan guifg=fg
    CSAHi Comment term=bold cterm=NONE ctermbg=bg ctermfg=210 gui=NONE guibg=bg guifg=#ff5050
    CSAHi Constant term=underline cterm=NONE ctermbg=bg ctermfg=35 gui=NONE guibg=bg guifg=#00884c
    CSAHi Special term=bold cterm=NONE ctermbg=bg ctermfg=135 gui=NONE guibg=bg guifg=#8040f0
    CSAHi Identifier term=underline cterm=NONE ctermbg=bg ctermfg=136 gui=NONE guibg=bg guifg=#b07800
    CSAHi Statement term=bold cterm=bold ctermbg=bg ctermfg=143 gui=bold guibg=bg guifg=#80a030
    CSAHi PreProc term=underline cterm=NONE ctermbg=bg ctermfg=37 gui=NONE guibg=bg guifg=#0090a0
    CSAHi Type term=underline cterm=bold ctermbg=bg ctermfg=138 gui=bold guibg=bg guifg=#b06c58
    CSAHi FoldColumn term=NONE cterm=NONE ctermbg=224 ctermfg=137 gui=NONE guibg=#f8d8c4 guifg=#a05040
    CSAHi DiffAdd term=bold cterm=NONE ctermbg=229 ctermfg=203 gui=NONE guibg=#eaf2b0 guifg=#ff2020
    CSAHi DiffChange term=bold cterm=NONE ctermbg=194 ctermfg=71 gui=NONE guibg=#c0f0d0 guifg=#208040
    CSAHi DiffDelete term=bold cterm=NONE ctermbg=229 ctermfg=203 gui=NONE guibg=#eaf2b0 guifg=#ff2020
    CSAHi DiffText term=reverse cterm=NONE ctermbg=189 ctermfg=67 gui=NONE guibg=#c0d0f0 guifg=#2850a0
...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_eterm") && g:CSApprox_eterm) || &term =~? "^eterm"
    ...
    CSAHi Underlined term=underline cterm=underline ctermbg=bg ctermfg=21 gui=underline guibg=bg guifg=blue
    CSAHi Ignore term=NONE cterm=NONE ctermbg=bg ctermfg=231 gui=NONE guibg=bg guifg=bg
    CSAHi Error term=reverse cterm=bold ctermbg=105 ctermfg=255 gui=bold guibg=#4040ff guifg=#f8f8f8
    CSAHi Todo term=NONE cterm=bold,underline ctermbg=bg ctermfg=39 gui=bold,underline guibg=bg guifg=#0080f0
    CSAHi SpecialKey term=bold cterm=NONE ctermbg=bg ctermfg=39 gui=NONE guibg=bg guifg=#0080ff
    CSAHi NonText term=bold cterm=bold ctermbg=231 ctermfg=174 gui=bold guibg=#ffe4d4 guifg=#a05040
    CSAHi Directory term=bold cterm=NONE ctermbg=bg ctermfg=141 gui=NONE guibg=bg guifg=#7050ff
    CSAHi ErrorMsg term=NONE cterm=bold ctermbg=105 ctermfg=255 gui=bold guibg=#4040ff guifg=#f8f8f8
    ...
    CSAHi MoreMsg term=bold cterm=NONE ctermbg=bg ctermfg=38 gui=NONE guibg=bg guifg=#0090a0
    CSAHi ModeMsg term=bold cterm=NONE ctermbg=bg ctermfg=208 gui=NONE guibg=bg guifg=#d06000
    CSAHi LineNr term=underline cterm=NONE ctermbg=bg ctermfg=223 gui=NONE guibg=bg guifg=#e0b090
    CSAHi Pmenu term=NONE cterm=NONE ctermbg=225 ctermfg=fg gui=NONE guibg=LightMagenta guifg=fg
    CSAHi PmenuSel term=NONE cterm=NONE ctermbg=250 ctermfg=fg gui=NONE guibg=Grey guifg=fg
    CSAHi PmenuSbar term=NONE cterm=NONE ctermbg=250 ctermfg=fg gui=NONE guibg=Grey guifg=fg
    CSAHi PmenuThumb term=NONE cterm=NONE ctermbg=238 ctermfg=231 gui=reverse guibg=bg guifg=fg
    ...
    CSAHi Question term=NONE cterm=NONE ctermbg=bg ctermfg=129 gui=NONE guibg=bg guifg=#8000ff
    CSAHi StatusLine term=reverse,bold cterm=bold ctermbg=137 ctermfg=255 gui=bold guibg=#904838 guifg=#f8f8f8
    CSAHi StatusLineNC term=reverse cterm=bold ctermbg=137 ctermfg=224 gui=bold guibg=#904838 guifg=#c0b0a0
    ...
    CSAHi VisualNOS term=bold,underline cterm=bold,underline ctermbg=bg ctermfg=fg gui=bold,underline guibg=bg guifg=fg
    CSAHi WarningMsg term=NONE cterm=bold ctermbg=105 ctermfg=255 gui=bold guibg=#4040ff guifg=#f8f8f8
    CSAHi WildMenu term=NONE cterm=bold ctermbg=203 ctermfg=255 gui=bold guibg=#ff3030 guifg=#f8f8f8
    CSAHi Folded term=NONE cterm=NONE ctermbg=230 ctermfg=137 gui=NONE guibg=#ffc0a0 guifg=#804030
    CSAHi lCursor term=NONE cterm=NONE ctermbg=141 ctermfg=255 gui=NONE guibg=#8040ff guifg=#ffffff
    CSAHi MatchParen term=reverse cterm=NONE ctermbg=51 ctermfg=fg gui=NONE guibg=Cyan guifg=fg
    CSAHi Comment term=bold cterm=NONE ctermbg=bg ctermfg=210 gui=NONE guibg=bg guifg=#ff5050
    CSAHi Constant term=underline cterm=NONE ctermbg=bg ctermfg=36 gui=NONE guibg=bg guifg=#00884c
    CSAHi Special term=bold cterm=NONE ctermbg=bg ctermfg=141 gui=NONE guibg=bg guifg=#8040f0
    CSAHi Identifier term=underline cterm=NONE ctermbg=bg ctermfg=178 gui=NONE guibg=bg guifg=#b07800
    CSAHi Statement term=bold cterm=bold ctermbg=bg ctermfg=149 gui=bold guibg=bg guifg=#80a030
    CSAHi PreProc term=underline cterm=NONE ctermbg=bg ctermfg=38 gui=NONE guibg=bg guifg=#0090a0
    CSAHi Type term=underline cterm=bold ctermbg=bg ctermfg=180 gui=bold guibg=bg guifg=#b06c58
    CSAHi FoldColumn term=NONE cterm=NONE ctermbg=231 ctermfg=174 gui=NONE guibg=#f8d8c4 guifg=#a05040
    CSAHi DiffAdd term=bold cterm=NONE ctermbg=230 ctermfg=203 gui=NONE guibg=#eaf2b0 guifg=#ff2020
    CSAHi DiffChange term=bold cterm=NONE ctermbg=231 ctermfg=72 gui=NONE guibg=#c0f0d0 guifg=#208040
    CSAHi DiffDelete term=bold cterm=NONE ctermbg=230 ctermfg=203 gui=NONE guibg=#eaf2b0 guifg=#ff2020
    CSAHi DiffText term=reverse cterm=NONE ctermbg=231 ctermfg=68 gui=NONE guibg=#c0d0f0 guifg=#2850a0
    CSAHi SignColumn term=NONE cterm=NONE ctermbg=250 ctermfg=19 gui=NONE guibg=Grey guifg=DarkBlue
    CSAHi SpellBad term=reverse cterm=undercurl ctermbg=bg ctermfg=196 gui=undercurl guibg=bg guifg=fg guisp=Red
    CSAHi SpellCap term=reverse cterm=undercurl ctermbg=bg ctermfg=21 gui=undercurl guibg=bg guifg=fg guisp=Blue
    CSAHi SpellRare term=reverse cterm=undercurl ctermbg=bg ctermfg=201 gui=undercurl guibg=bg guifg=fg guisp=Magenta
