...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsole) || &term =~? "^konsole"
    ...
    CSAHi StatusLine term=reverse,bold cterm=bold ctermbg=21 ctermfg=231 gui=reverse,bold guibg=white guifg=blue
...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_eterm") && g:CSApprox_eterm) || &term =~? "^eterm"
    ...
    CSAHi Cursor term=NONE cterm=bold ctermbg=46 ctermfg=16 gui=bold guibg=Green guifg=Black
    CSAHi Question term=NONE cterm=bold ctermbg=bg ctermfg=72 gui=bold guibg=bg guifg=SeaGreen
    CSAHi StatusLine term=reverse,bold cterm=bold ctermbg=21 ctermfg=255 gui=reverse,bold guibg=white guifg=blue
...
elseif has("gui_running") || &t_Co == 88
    ...
    CSAHi StatusLine term=reverse,bold cterm=bold ctermbg=19 ctermfg=79 gui=reverse,bold guibg=white guifg=blue
