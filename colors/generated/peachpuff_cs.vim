...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsole) || &term =~? "^konsole"
    CSAHi Normal term=NONE cterm=NONE ctermbg=224 ctermfg=16 gui=NONE guibg=PeachPuff guifg=Black
    CSAHi Underlined term=underline cterm=underline ctermbg=bg ctermfg=104 gui=underline guibg=bg guifg=SlateBlue
    CSAHi Ignore term=NONE cterm=NONE ctermbg=bg ctermfg=224 gui=NONE guibg=bg guifg=bg
    ...
    CSAHi Cursor term=NONE cterm=NONE ctermbg=16 ctermfg=224 gui=NONE guibg=fg guifg=bg
    ...
    CSAHi StatusLineNC term=reverse cterm=bold ctermbg=243 ctermfg=224 gui=bold guibg=Gray45 guifg=PeachPuff
    ...
    CSAHi Visual term=reverse cterm=NONE ctermbg=188 ctermfg=16 gui=reverse guibg=fg guifg=Grey80
    ...
    CSAHi Folded term=NONE cterm=NONE ctermbg=187 ctermfg=16 gui=NONE guibg=#e3c1a5 guifg=Black
    CSAHi lCursor term=NONE cterm=NONE ctermbg=16 ctermfg=224 gui=NONE guibg=fg guifg=bg
    ...
    CSAHi FoldColumn term=NONE cterm=NONE ctermbg=188 ctermfg=19 gui=NONE guibg=Gray80 guifg=DarkBlue
...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_eterm") && g:CSApprox_eterm) || &term =~? "^eterm"
    CSAHi Normal term=NONE cterm=NONE ctermbg=230 ctermfg=16 gui=NONE guibg=PeachPuff guifg=Black
    ...
    CSAHi Search term=reverse cterm=NONE ctermbg=226 ctermfg=fg gui=NONE guibg=Gold2 guifg=fg
    CSAHi MoreMsg term=bold cterm=bold ctermbg=bg ctermfg=72 gui=bold guibg=bg guifg=SeaGreen
    CSAHi ModeMsg term=bold cterm=bold ctermbg=bg ctermfg=fg gui=bold guibg=bg guifg=fg
    CSAHi LineNr term=underline cterm=NONE ctermbg=bg ctermfg=196 gui=NONE guibg=bg guifg=Red3
    CSAHi Pmenu term=NONE cterm=NONE ctermbg=225 ctermfg=fg gui=NONE guibg=LightMagenta guifg=fg
    CSAHi PmenuSel term=NONE cterm=NONE ctermbg=250 ctermfg=fg gui=NONE guibg=Grey guifg=fg
    CSAHi PmenuSbar term=NONE cterm=NONE ctermbg=250 ctermfg=fg gui=NONE guibg=Grey guifg=fg
    ...
    CSAHi StatusLineNC term=reverse cterm=bold ctermbg=243 ctermfg=230 gui=bold guibg=Gray45 guifg=PeachPuff
    CSAHi VertSplit term=reverse cterm=bold ctermbg=243 ctermfg=255 gui=bold guibg=Gray45 guifg=White
    CSAHi Title term=bold cterm=bold ctermbg=bg ctermfg=199 gui=bold guibg=bg guifg=DeepPink3
    CSAHi Visual term=reverse cterm=NONE ctermbg=252 ctermfg=16 gui=reverse guibg=fg guifg=Grey80
    CSAHi VisualNOS term=bold,underline cterm=bold,underline ctermbg=bg ctermfg=fg gui=bold,underline guibg=bg guifg=fg
    CSAHi WarningMsg term=NONE cterm=bold ctermbg=bg ctermfg=196 gui=bold guibg=bg guifg=Red
    CSAHi WildMenu term=NONE cterm=NONE ctermbg=226 ctermfg=16 gui=NONE guibg=Yellow guifg=Black
    CSAHi Folded term=NONE cterm=NONE ctermbg=230 ctermfg=16 gui=NONE guibg=#e3c1a5 guifg=Black
    ...
    CSAHi Type term=underline cterm=bold ctermbg=bg ctermfg=72 gui=bold guibg=bg guifg=SeaGreen
    CSAHi FoldColumn term=NONE cterm=NONE ctermbg=252 ctermfg=19 gui=NONE guibg=Gray80 guifg=DarkBlue
