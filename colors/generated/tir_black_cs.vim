...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsole) || &term =~? "^konsole"
    ...
    CSAHi Error term=reverse cterm=undercurl ctermbg=196 ctermfg=210 gui=undercurl guibg=Red guifg=White guisp=#FF6C60
    CSAHi Todo term=NONE cterm=NONE ctermbg=193 ctermfg=16 gui=NONE guibg=#cae682 guifg=#000000
    ...
    CSAHi NonText term=bold cterm=bold ctermbg=16 ctermfg=232 gui=bold guibg=black guifg=#070707
    CSAHi Directory term=bold cterm=NONE ctermbg=bg ctermfg=51 gui=NONE guibg=bg guifg=Blue
    ...
    CSAHi Search term=reverse cterm=NONE ctermbg=193 ctermfg=16 gui=NONE guibg=#cae682 guifg=#000000
    ...
    CSAHi TabLine term=underline cterm=underline ctermbg=248 ctermfg=fg gui=underline guibg=LightGrey guifg=fg
    ...
    CSAHi StatusLineNC term=reverse cterm=NONE ctermbg=16 ctermfg=234 gui=reverse guibg=#202020 guifg=black
    CSAHi VertSplit term=reverse cterm=NONE ctermbg=234 ctermfg=234 gui=reverse guibg=#202020 guifg=#202020
    ...
    CSAHi WildMenu term=NONE cterm=NONE ctermbg=193 ctermfg=16 gui=NONE guibg=#cae682 guifg=black
    ...
    CSAHi Statement term=bold cterm=bold ctermbg=bg ctermfg=110 gui=bold guibg=bg guifg=#6699CC
    CSAHi PreProc term=underline cterm=NONE ctermbg=bg ctermfg=153 gui=NONE guibg=bg guifg=#96CBFE
    CSAHi Type term=underline cterm=bold ctermbg=bg ctermfg=230 gui=bold guibg=bg guifg=#FFFFB6
    CSAHi Delimiter term=NONE cterm=NONE ctermbg=bg ctermfg=37 gui=NONE guibg=bg guifg=#00A0A0
    CSAHi FoldColumn term=NONE cterm=NONE ctermbg=250 ctermfg=51 gui=NONE guibg=Grey guifg=DarkBlue
...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_eterm") && g:CSApprox_eterm) || &term =~? "^eterm"
    ...
    CSAHi Ignore term=NONE cterm=NONE ctermbg=bg ctermfg=16 gui=NONE guibg=bg guifg=bg
    CSAHi Error term=reverse cterm=undercurl ctermbg=196 ctermfg=216 gui=undercurl guibg=Red guifg=White guisp=#FF6C60
    CSAHi Todo term=NONE cterm=NONE ctermbg=229 ctermfg=16 gui=NONE guibg=#cae682 guifg=#000000
    ...
    CSAHi IncSearch term=reverse cterm=NONE ctermbg=231 ctermfg=16 gui=reverse guibg=bg guifg=fg
    CSAHi Search term=reverse cterm=NONE ctermbg=229 ctermfg=16 gui=NONE guibg=#cae682 guifg=#000000
    CSAHi MoreMsg term=bold cterm=bold ctermbg=bg ctermfg=72 gui=bold guibg=bg guifg=SeaGreen
    ...
    CSAHi WildMenu term=NONE cterm=NONE ctermbg=229 ctermfg=16 gui=NONE guibg=#cae682 guifg=black
    ...
    CSAHi Statement term=bold cterm=bold ctermbg=bg ctermfg=117 gui=bold guibg=bg guifg=#6699CC
...
elseif has("gui_running") || &t_Co == 256
    ...
    CSAHi Ignore term=NONE cterm=NONE ctermbg=bg ctermfg=16 gui=NONE guibg=bg guifg=bg
    CSAHi Error term=reverse cterm=undercurl ctermbg=196 ctermfg=203 gui=undercurl guibg=Red guifg=White guisp=#FF6C60
    ...
    CSAHi Identifier term=underline cterm=NONE ctermbg=bg ctermfg=189 gui=NONE guibg=bg guifg=#C6C5FE
    CSAHi Statement term=bold cterm=bold ctermbg=bg ctermfg=68 gui=bold guibg=bg guifg=#6699CC
    CSAHi PreProc term=underline cterm=NONE ctermbg=bg ctermfg=117 gui=NONE guibg=bg guifg=#96CBFE
    CSAHi Type term=underline cterm=bold ctermbg=bg ctermfg=229 gui=bold guibg=bg guifg=#FFFFB6
    CSAHi Delimiter term=NONE cterm=NONE ctermbg=bg ctermfg=37 gui=NONE guibg=bg guifg=#00A0A0
...
elseif has("gui_running") || &t_Co == 88
    ...
    CSAHi Ignore term=NONE cterm=NONE ctermbg=bg ctermfg=16 gui=NONE guibg=bg guifg=bg
    CSAHi Error term=reverse cterm=undercurl ctermbg=64 ctermfg=69 gui=undercurl guibg=Red guifg=White guisp=#FF6C60
    ...
    CSAHi NonText term=bold cterm=bold ctermbg=16 ctermfg=16 gui=bold guibg=black guifg=#070707
    ...
    CSAHi StatusLineNC term=reverse cterm=NONE ctermbg=16 ctermfg=80 gui=reverse guibg=#202020 guifg=black
    CSAHi VertSplit term=reverse cterm=NONE ctermbg=80 ctermfg=80 gui=reverse guibg=#202020 guifg=#202020
    ...
    CSAHi Statement term=bold cterm=bold ctermbg=bg ctermfg=38 gui=bold guibg=bg guifg=#6699CC
    CSAHi PreProc term=underline cterm=NONE ctermbg=bg ctermfg=43 gui=NONE guibg=bg guifg=#96CBFE
    CSAHi Type term=underline cterm=bold ctermbg=bg ctermfg=78 gui=bold guibg=bg guifg=#FFFFB6
