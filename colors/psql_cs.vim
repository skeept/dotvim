...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsole) || &term =~? "^konsole"
    ...
    CSAHi Visual term=reverse cterm=NONE ctermbg=147 ctermfg=250 gui=reverse guibg=fg guifg=#8080ff
    CSAHi VisualNOS term=bold,underline cterm=underline ctermbg=147 ctermfg=250 gui=reverse,underline guibg=fg guifg=#8080ff
    ...
    CSAHi DiffAdd term=NONE cterm=NONE ctermbg=19 ctermfg=fg gui=NONE guibg=darkblue guifg=fg
