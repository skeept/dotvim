...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsole) || &term =~? "^konsole"
    CSAHi Normal term=NONE cterm=NONE ctermbg=16 ctermfg=46 gui=NONE guibg=Black guifg=Green
    ...
    CSAHi Float term=NONE cterm=NONE ctermbg=bg ctermfg=147 gui=NONE guibg=bg guifg=#88AAEE
    ...
    CSAHi IncSearch term=reverse cterm=NONE ctermbg=46 ctermfg=16 gui=reverse guibg=bg guifg=fg
    ...
    CSAHi PmenuThumb term=NONE cterm=NONE ctermbg=46 ctermfg=16 gui=reverse guibg=bg guifg=fg
    CSAHi TabLine term=underline cterm=underline ctermbg=252 ctermfg=fg gui=underline guibg=LightGrey guifg=fg
    CSAHi TabLineSel term=bold cterm=bold ctermbg=bg ctermfg=fg gui=bold guibg=bg guifg=fg
    CSAHi TabLineFill term=reverse cterm=NONE ctermbg=46 ctermfg=16 gui=reverse guibg=bg guifg=fg
    CSAHi CursorColumn term=reverse cterm=NONE ctermbg=254 ctermfg=fg gui=NONE guibg=Grey90 guifg=fg
    CSAHi CursorLine term=underline cterm=NONE ctermbg=254 ctermfg=fg gui=NONE guibg=Grey90 guifg=fg
    CSAHi Cursor term=NONE cterm=NONE ctermbg=249 ctermfg=231 gui=NONE guibg=Grey70 guifg=White
    CSAHi Exception term=NONE cterm=NONE ctermbg=231 ctermfg=196 gui=NONE guibg=White guifg=Red
    CSAHi Question term=NONE cterm=bold ctermbg=bg ctermfg=72 gui=bold guibg=bg guifg=SeaGreen
    CSAHi StatusLine term=reverse,bold cterm=bold ctermbg=248 ctermfg=214 gui=bold guibg=DarkGrey guifg=Orange
    CSAHi StatusLineNC term=reverse cterm=NONE ctermbg=214 ctermfg=248 gui=reverse guibg=DarkGrey guifg=Orange
    CSAHi VertSplit term=reverse cterm=NONE ctermbg=46 ctermfg=16 gui=reverse guibg=bg guifg=fg
    CSAHi Title term=bold cterm=bold ctermbg=bg ctermfg=201 gui=bold guibg=bg guifg=Magenta
    CSAHi Visual term=reverse cterm=NONE ctermbg=249 ctermfg=16 gui=NONE guibg=Grey70 guifg=Black
    ...
    CSAHi lCursor term=NONE cterm=NONE ctermbg=46 ctermfg=16 gui=NONE guibg=fg guifg=bg
    CSAHi MatchParen term=reverse cterm=NONE ctermbg=51 ctermfg=fg gui=NONE guibg=Cyan guifg=fg
    CSAHi Comment term=bold cterm=NONE ctermbg=bg ctermfg=189 gui=NONE guibg=bg guifg=#d1ddff
    ...
    CSAHi PreProc term=underline cterm=NONE ctermbg=bg ctermfg=202 gui=NONE guibg=bg guifg=#ff4500
    CSAHi Type term=underline cterm=bold ctermbg=bg ctermfg=111 gui=bold guibg=bg guifg=#7d96ff
    CSAHi Typedef term=NONE cterm=bold ctermbg=21 ctermfg=231 gui=bold guibg=Blue guifg=White
    CSAHi SpecialChar term=NONE cterm=NONE ctermbg=231 ctermfg=16 gui=NONE guibg=White guifg=Black
    CSAHi Delimiter term=NONE cterm=NONE ctermbg=16 ctermfg=231 gui=NONE guibg=Black guifg=White
    CSAHi SpecialComment term=NONE cterm=NONE ctermbg=46 ctermfg=16 gui=NONE guibg=Green guifg=Black
...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_eterm") && g:CSApprox_eterm) || &term =~? "^eterm"
    ...
    CSAHi Todo term=NONE cterm=NONE ctermbg=226 ctermfg=21 gui=NONE guibg=Yellow guifg=Blue
    CSAHi Float term=NONE cterm=NONE ctermbg=bg ctermfg=153 gui=NONE guibg=bg guifg=#88AAEE
    CSAHi SpecialKey term=bold cterm=NONE ctermbg=bg ctermfg=21 gui=NONE guibg=bg guifg=Blue
    ...
    CSAHi CursorColumn term=reverse cterm=NONE ctermbg=254 ctermfg=fg gui=NONE guibg=Grey90 guifg=fg
    CSAHi CursorLine term=underline cterm=NONE ctermbg=254 ctermfg=fg gui=NONE guibg=Grey90 guifg=fg
    CSAHi Cursor term=NONE cterm=NONE ctermbg=249 ctermfg=255 gui=NONE guibg=Grey70 guifg=White
    CSAHi Exception term=NONE cterm=NONE ctermbg=255 ctermfg=196 gui=NONE guibg=White guifg=Red
    CSAHi Question term=NONE cterm=bold ctermbg=bg ctermfg=72 gui=bold guibg=bg guifg=SeaGreen
    CSAHi StatusLine term=reverse,bold cterm=bold ctermbg=248 ctermfg=220 gui=bold guibg=DarkGrey guifg=Orange
    CSAHi StatusLineNC term=reverse cterm=NONE ctermbg=220 ctermfg=248 gui=reverse guibg=DarkGrey guifg=Orange
    CSAHi VertSplit term=reverse cterm=NONE ctermbg=46 ctermfg=16 gui=reverse guibg=bg guifg=fg
    CSAHi Title term=bold cterm=bold ctermbg=bg ctermfg=201 gui=bold guibg=bg guifg=Magenta
    CSAHi Visual term=reverse cterm=NONE ctermbg=249 ctermfg=16 gui=NONE guibg=Grey70 guifg=Black
    CSAHi VisualNOS term=bold,underline cterm=bold,underline ctermbg=bg ctermfg=fg gui=bold,underline guibg=bg guifg=fg
    ...
    CSAHi lCursor term=NONE cterm=NONE ctermbg=46 ctermfg=16 gui=NONE guibg=fg guifg=bg
    CSAHi MatchParen term=reverse cterm=NONE ctermbg=51 ctermfg=fg gui=NONE guibg=Cyan guifg=fg
    CSAHi Comment term=bold cterm=NONE ctermbg=bg ctermfg=231 gui=NONE guibg=bg guifg=#d1ddff
    ...
    CSAHi Statement term=bold cterm=bold ctermbg=bg ctermfg=228 gui=bold guibg=bg guifg=#ffff60
    CSAHi PreProc term=underline cterm=NONE ctermbg=bg ctermfg=208 gui=NONE guibg=bg guifg=#ff4500
    CSAHi Type term=underline cterm=bold ctermbg=bg ctermfg=153 gui=bold guibg=bg guifg=#7d96ff
    CSAHi Typedef term=NONE cterm=bold ctermbg=21 ctermfg=255 gui=bold guibg=Blue guifg=White
    CSAHi SpecialChar term=NONE cterm=NONE ctermbg=255 ctermfg=16 gui=NONE guibg=White guifg=Black
    CSAHi Delimiter term=NONE cterm=NONE ctermbg=16 ctermfg=255 gui=NONE guibg=Black guifg=White
    CSAHi SpecialComment term=NONE cterm=NONE ctermbg=46 ctermfg=16 gui=NONE guibg=Green guifg=Black
    CSAHi FoldColumn term=NONE cterm=NONE ctermbg=250 ctermfg=19 gui=NONE guibg=Grey guifg=DarkBlue
...
elseif has("gui_running") || &t_Co == 256
    ...
    CSAHi Error term=reverse cterm=NONE ctermbg=196 ctermfg=231 gui=NONE guibg=Red guifg=White
    CSAHi Todo term=NONE cterm=NONE ctermbg=226 ctermfg=21 gui=NONE guibg=Yellow guifg=Blue
    CSAHi Float term=NONE cterm=NONE ctermbg=bg ctermfg=111 gui=NONE guibg=bg guifg=#88AAEE
    CSAHi SpecialKey term=bold cterm=NONE ctermbg=bg ctermfg=21 gui=NONE guibg=bg guifg=Blue
    CSAHi NonText term=bold cterm=bold ctermbg=252 ctermfg=21 gui=bold guibg=Grey80 guifg=Blue
    CSAHi Directory term=bold cterm=NONE ctermbg=bg ctermfg=21 gui=NONE guibg=bg guifg=Blue
    CSAHi ErrorMsg term=NONE cterm=NONE ctermbg=196 ctermfg=231 gui=NONE guibg=Red guifg=White
    ...
    CSAHi PreProc term=underline cterm=NONE ctermbg=bg ctermfg=202 gui=NONE guibg=bg guifg=#ff4500
    CSAHi Type term=underline cterm=bold ctermbg=bg ctermfg=105 gui=bold guibg=bg guifg=#7d96ff
    CSAHi Typedef term=NONE cterm=bold ctermbg=21 ctermfg=231 gui=bold guibg=Blue guifg=White
    CSAHi SpecialChar term=NONE cterm=NONE ctermbg=231 ctermfg=16 gui=NONE guibg=White guifg=Black
    CSAHi Delimiter term=NONE cterm=NONE ctermbg=16 ctermfg=231 gui=NONE guibg=Black guifg=White
    CSAHi SpecialComment term=NONE cterm=NONE ctermbg=46 ctermfg=16 gui=NONE guibg=Green guifg=Black
...
elseif has("gui_running") || &t_Co == 88
    CSAHi Normal term=NONE cterm=NONE ctermbg=16 ctermfg=28 gui=NONE guibg=Black guifg=Green
    ...
    CSAHi Float term=NONE cterm=NONE ctermbg=bg ctermfg=39 gui=NONE guibg=bg guifg=#88AAEE
    ...
    CSAHi IncSearch term=reverse cterm=NONE ctermbg=28 ctermfg=16 gui=reverse guibg=bg guifg=fg
    ...
    CSAHi PmenuThumb term=NONE cterm=NONE ctermbg=28 ctermfg=16 gui=reverse guibg=bg guifg=fg
    CSAHi TabLine term=underline cterm=underline ctermbg=86 ctermfg=fg gui=underline guibg=LightGrey guifg=fg
    CSAHi TabLineSel term=bold cterm=bold ctermbg=bg ctermfg=fg gui=bold guibg=bg guifg=fg
    CSAHi TabLineFill term=reverse cterm=NONE ctermbg=28 ctermfg=16 gui=reverse guibg=bg guifg=fg
    CSAHi CursorColumn term=reverse cterm=NONE ctermbg=87 ctermfg=fg gui=NONE guibg=Grey90 guifg=fg
    CSAHi CursorLine term=underline cterm=NONE ctermbg=87 ctermfg=fg gui=NONE guibg=Grey90 guifg=fg
    CSAHi Cursor term=NONE cterm=NONE ctermbg=85 ctermfg=79 gui=NONE guibg=Grey70 guifg=White
    CSAHi Exception term=NONE cterm=NONE ctermbg=79 ctermfg=64 gui=NONE guibg=White guifg=Red
    CSAHi Question term=NONE cterm=bold ctermbg=bg ctermfg=21 gui=bold guibg=bg guifg=SeaGreen
    CSAHi StatusLine term=reverse,bold cterm=bold ctermbg=84 ctermfg=68 gui=bold guibg=DarkGrey guifg=Orange
    CSAHi StatusLineNC term=reverse cterm=NONE ctermbg=68 ctermfg=84 gui=reverse guibg=DarkGrey guifg=Orange
    CSAHi VertSplit term=reverse cterm=NONE ctermbg=28 ctermfg=16 gui=reverse guibg=bg guifg=fg
    CSAHi Title term=bold cterm=bold ctermbg=bg ctermfg=67 gui=bold guibg=bg guifg=Magenta
    CSAHi Visual term=reverse cterm=NONE ctermbg=85 ctermfg=16 gui=NONE guibg=Grey70 guifg=Black
    CSAHi VisualNOS term=bold,underline cterm=bold,underline ctermbg=bg ctermfg=fg gui=bold,underline guibg=bg guifg=fg
    ...
    CSAHi lCursor term=NONE cterm=NONE ctermbg=28 ctermfg=16 gui=NONE guibg=fg guifg=bg
    CSAHi MatchParen term=reverse cterm=NONE ctermbg=31 ctermfg=fg gui=NONE guibg=Cyan guifg=fg
    CSAHi Comment term=bold cterm=NONE ctermbg=bg ctermfg=59 gui=NONE guibg=bg guifg=#d1ddff
    ...
    CSAHi PreProc term=underline cterm=NONE ctermbg=bg ctermfg=64 gui=NONE guibg=bg guifg=#ff4500
    CSAHi Type term=underline cterm=bold ctermbg=bg ctermfg=39 gui=bold guibg=bg guifg=#7d96ff
    CSAHi Typedef term=NONE cterm=bold ctermbg=19 ctermfg=79 gui=bold guibg=Blue guifg=White
    CSAHi SpecialChar term=NONE cterm=NONE ctermbg=79 ctermfg=16 gui=NONE guibg=White guifg=Black
    CSAHi Delimiter term=NONE cterm=NONE ctermbg=16 ctermfg=79 gui=NONE guibg=Black guifg=White
    CSAHi SpecialComment term=NONE cterm=NONE ctermbg=28 ctermfg=16 gui=NONE guibg=Green guifg=Black
