...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsole) || &term =~? "^konsole"
    ...
    CSAHi Number term=underline cterm=bold ctermbg=bg ctermfg=196 gui=bold guibg=bg guifg=Red
    ...
    CSAHi Comment term=NONE cterm=NONE ctermbg=bg ctermfg=37 gui=NONE guibg=bg guifg=DarkCyan
    ...
    CSAHi Identifier term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Statement term=bold cterm=bold ctermbg=bg ctermfg=fg gui=bold guibg=bg guifg=fg
    CSAHi PreProc term=NONE cterm=NONE ctermbg=bg ctermfg=21 gui=NONE guibg=bg guifg=Blue
...
elseif has("gui_running") || &t_Co == 256
    ...
    CSAHi lCursor term=NONE cterm=NONE ctermbg=16 ctermfg=231 gui=NONE guibg=fg guifg=bg
    CSAHi MatchParen term=reverse cterm=NONE ctermbg=51 ctermfg=fg gui=NONE guibg=Cyan guifg=fg
    CSAHi Comment term=NONE cterm=NONE ctermbg=bg ctermfg=30 gui=NONE guibg=bg guifg=DarkCyan
    CSAHi Constant term=underline cterm=NONE ctermbg=bg ctermfg=196 gui=NONE guibg=bg guifg=Red
    CSAHi Special term=NONE cterm=bold ctermbg=bg ctermfg=196 gui=bold guibg=bg guifg=Red
    CSAHi Identifier term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Statement term=bold cterm=bold ctermbg=bg ctermfg=fg gui=bold guibg=bg guifg=fg
...
elseif has("gui_running") || &t_Co == 88
    ...
    CSAHi Number term=underline cterm=bold ctermbg=bg ctermfg=64 gui=bold guibg=bg guifg=Red
    ...
    CSAHi Comment term=NONE cterm=NONE ctermbg=bg ctermfg=21 gui=NONE guibg=bg guifg=DarkCyan
    ...
    CSAHi Identifier term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Statement term=bold cterm=bold ctermbg=bg ctermfg=fg gui=bold guibg=bg guifg=fg
    CSAHi PreProc term=NONE cterm=NONE ctermbg=bg ctermfg=19 gui=NONE guibg=bg guifg=Blue
