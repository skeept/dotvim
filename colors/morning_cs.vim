...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsole) || &term =~? "^konsole"
    ...
    CSAHi CursorColumn term=reverse cterm=NONE ctermbg=188 ctermfg=fg gui=NONE guibg=grey80 guifg=fg
    CSAHi CursorLine term=underline cterm=NONE ctermbg=188 ctermfg=fg gui=NONE guibg=grey80 guifg=fg
    ...
    CSAHi Visual term=reverse cterm=NONE ctermbg=188 ctermfg=fg gui=NONE guibg=grey80 guifg=fg
    ...
    CSAHi Constant term=underline cterm=NONE ctermbg=255 ctermfg=201 gui=NONE guibg=grey95 guifg=Magenta
    CSAHi Special term=bold cterm=NONE ctermbg=255 ctermfg=104 gui=NONE guibg=grey95 guifg=SlateBlue
...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_eterm") && g:CSApprox_eterm) || &term =~? "^eterm"
    ...
    CSAHi TabLineSel term=bold cterm=bold ctermbg=bg ctermfg=fg gui=bold guibg=bg guifg=fg
    CSAHi TabLineFill term=reverse cterm=NONE ctermbg=16 ctermfg=254 gui=reverse guibg=bg guifg=fg
    CSAHi CursorColumn term=reverse cterm=NONE ctermbg=252 ctermfg=fg gui=NONE guibg=grey80 guifg=fg
    CSAHi CursorLine term=underline cterm=NONE ctermbg=252 ctermfg=fg gui=NONE guibg=grey80 guifg=fg
    CSAHi Cursor term=NONE cterm=NONE ctermbg=46 ctermfg=fg gui=NONE guibg=Green guifg=fg
    CSAHi Question term=NONE cterm=bold ctermbg=bg ctermfg=72 gui=bold guibg=bg guifg=SeaGreen
    CSAHi StatusLine term=reverse,bold cterm=bold ctermbg=16 ctermfg=254 gui=reverse,bold guibg=bg guifg=fg
    CSAHi StatusLineNC term=reverse cterm=NONE ctermbg=16 ctermfg=254 gui=reverse guibg=bg guifg=fg
    CSAHi VertSplit term=reverse cterm=NONE ctermbg=16 ctermfg=254 gui=reverse guibg=bg guifg=fg
    CSAHi Title term=bold cterm=bold ctermbg=bg ctermfg=201 gui=bold guibg=bg guifg=Magenta
    CSAHi Visual term=reverse cterm=NONE ctermbg=252 ctermfg=fg gui=NONE guibg=grey80 guifg=fg
    CSAHi VisualNOS term=bold,underline cterm=bold,underline ctermbg=bg ctermfg=fg gui=bold,underline guibg=bg guifg=fg
    CSAHi WarningMsg term=NONE cterm=NONE ctermbg=bg ctermfg=196 gui=NONE guibg=bg guifg=Red
    CSAHi WildMenu term=NONE cterm=NONE ctermbg=226 ctermfg=16 gui=NONE guibg=Yellow guifg=Black
    ...
    CSAHi Comment term=bold cterm=NONE ctermbg=bg ctermfg=21 gui=NONE guibg=bg guifg=Blue
    CSAHi Constant term=underline cterm=NONE ctermbg=255 ctermfg=201 gui=NONE guibg=grey95 guifg=Magenta
    CSAHi Special term=bold cterm=NONE ctermbg=255 ctermfg=105 gui=NONE guibg=grey95 guifg=SlateBlue
    CSAHi Identifier term=underline cterm=NONE ctermbg=bg ctermfg=37 gui=NONE guibg=bg guifg=DarkCyan
...
elseif has("gui_running") || &t_Co == 256
    ...
    CSAHi Comment term=bold cterm=NONE ctermbg=bg ctermfg=21 gui=NONE guibg=bg guifg=Blue
    CSAHi Constant term=underline cterm=NONE ctermbg=255 ctermfg=201 gui=NONE guibg=grey95 guifg=Magenta
    CSAHi Special term=bold cterm=NONE ctermbg=255 ctermfg=62 gui=NONE guibg=grey95 guifg=SlateBlue
...
elseif has("gui_running") || &t_Co == 88
    ...
    CSAHi CursorColumn term=reverse cterm=NONE ctermbg=58 ctermfg=fg gui=NONE guibg=grey80 guifg=fg
    CSAHi CursorLine term=underline cterm=NONE ctermbg=58 ctermfg=fg gui=NONE guibg=grey80 guifg=fg
    ...
    CSAHi Visual term=reverse cterm=NONE ctermbg=58 ctermfg=fg gui=NONE guibg=grey80 guifg=fg
    CSAHi VisualNOS term=bold,underline cterm=bold,underline ctermbg=bg ctermfg=fg gui=bold,underline guibg=bg guifg=fg
    ...
    CSAHi Constant term=underline cterm=NONE ctermbg=87 ctermfg=67 gui=NONE guibg=grey95 guifg=Magenta
    CSAHi Special term=bold cterm=NONE ctermbg=87 ctermfg=38 gui=NONE guibg=grey95 guifg=SlateBlue
