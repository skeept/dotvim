...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsole) || &term =~? "^konsole"
    ...
    CSAHi String term=NONE cterm=NONE ctermbg=bg ctermfg=40 gui=NONE guibg=bg guifg=#00bb00
    CSAHi Boolean term=NONE cterm=NONE ctermbg=bg ctermfg=46 gui=NONE guibg=bg guifg=#00ff00
    CSAHi Function term=NONE cterm=NONE ctermbg=16 ctermfg=46 gui=NONE guibg=#000000 guifg=#00ff00
    CSAHi SpecialKey term=bold cterm=NONE ctermbg=16 ctermfg=46 gui=NONE guibg=#000000 guifg=#00ff00
    CSAHi NonText term=bold cterm=bold ctermbg=16 ctermfg=231 gui=bold guibg=#000000 guifg=#ffffff
    CSAHi Directory term=bold cterm=NONE ctermbg=16 ctermfg=46 gui=NONE guibg=#000000 guifg=#00ff00
    CSAHi ErrorMsg term=NONE cterm=NONE ctermbg=231 ctermfg=16 gui=NONE guibg=#ffffff guifg=#000000
    CSAHi IncSearch term=reverse cterm=NONE ctermbg=40 ctermfg=16 gui=NONE guibg=#00bb00 guifg=#000000
    CSAHi Search term=reverse cterm=NONE ctermbg=46 ctermfg=16 gui=NONE guibg=#00ff00 guifg=#000000
    CSAHi MoreMsg term=bold cterm=bold ctermbg=16 ctermfg=46 gui=bold guibg=#000000 guifg=#00ff00
    CSAHi ModeMsg term=bold cterm=bold ctermbg=16 ctermfg=46 gui=bold guibg=#000000 guifg=#00ff00
    CSAHi LineNr term=underline cterm=NONE ctermbg=16 ctermfg=34 gui=NONE guibg=#000000 guifg=#008800
    ...
    CSAHi TabLineSel term=bold cterm=NONE ctermbg=34 ctermfg=16 gui=NONE guibg=#00aa00 guifg=#000000
    CSAHi TabLineFill term=reverse cterm=underline ctermbg=16 ctermfg=231 gui=underline guibg=#000000 guifg=#ffffff
    CSAHi CursorColumn term=reverse cterm=NONE ctermbg=16 ctermfg=fg gui=NONE guibg=#001100 guifg=fg
    CSAHi CursorLine term=underline cterm=NONE ctermbg=16 ctermfg=fg gui=NONE guibg=#001800 guifg=fg
    ...
    CSAHi cDefine term=NONE cterm=NONE ctermbg=bg ctermfg=46 gui=NONE guibg=bg guifg=#00ff00
    CSAHi Question term=NONE cterm=bold ctermbg=bg ctermfg=46 gui=bold guibg=bg guifg=#00ff00
    CSAHi StatusLine term=reverse,bold cterm=NONE ctermbg=34 ctermfg=16 gui=NONE guibg=#008800 guifg=#000000
    ...
    CSAHi Title term=bold cterm=NONE ctermbg=bg ctermfg=46 gui=NONE guibg=bg guifg=#00ff00
    CSAHi Visual term=reverse cterm=NONE ctermbg=40 ctermfg=16 gui=NONE guibg=#00dd00 guifg=#000000
    ...
    CSAHi MatchParen term=reverse cterm=NONE ctermbg=235 ctermfg=46 gui=NONE guibg=#222222 guifg=#00ff00
    CSAHi Comment term=bold cterm=NONE ctermbg=bg ctermfg=102 gui=NONE guibg=bg guifg=#696969
    CSAHi Constant term=underline cterm=NONE ctermbg=bg ctermfg=46 gui=NONE guibg=bg guifg=#00ff00
    CSAHi Special term=bold cterm=NONE ctermbg=16 ctermfg=231 gui=NONE guibg=#000000 guifg=#ffffff
    CSAHi Identifier term=underline cterm=NONE ctermbg=16 ctermfg=40 gui=NONE guibg=#000000 guifg=#00bb00
    CSAHi Statement term=bold cterm=bold ctermbg=bg ctermfg=46 gui=bold guibg=bg guifg=#00ff00
    ...
    CSAHi DiffAdd term=bold cterm=NONE ctermbg=59 ctermfg=46 gui=NONE guibg=#333333 guifg=#00ff00
    CSAHi DiffChange term=bold cterm=NONE ctermbg=59 ctermfg=46 gui=NONE guibg=#333333 guifg=#00ff00
    CSAHi DiffDelete term=bold cterm=bold ctermbg=59 ctermfg=46 gui=bold guibg=#333333 guifg=#00ff00
...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_eterm") && g:CSApprox_eterm) || &term =~? "^eterm"
    ...
    CSAHi PmenuThumb term=NONE cterm=NONE ctermbg=250 ctermfg=16 gui=reverse guibg=bg guifg=fg
    CSAHi TabLine term=underline cterm=NONE ctermbg=238 ctermfg=16 gui=NONE guibg=#444444 guifg=#000000
    CSAHi TabLineSel term=bold cterm=NONE ctermbg=40 ctermfg=16 gui=NONE guibg=#00aa00 guifg=#000000
    CSAHi TabLineFill term=reverse cterm=underline ctermbg=16 ctermfg=255 gui=underline guibg=#000000 guifg=#ffffff
    CSAHi CursorColumn term=reverse cterm=NONE ctermbg=16 ctermfg=fg gui=NONE guibg=#001100 guifg=fg
    CSAHi CursorLine term=underline cterm=NONE ctermbg=22 ctermfg=fg gui=NONE guibg=#001800 guifg=fg
    ...
    CSAHi Title term=bold cterm=NONE ctermbg=bg ctermfg=46 gui=NONE guibg=bg guifg=#00ff00
    CSAHi Visual term=reverse cterm=NONE ctermbg=46 ctermfg=16 gui=NONE guibg=#00dd00 guifg=#000000
    CSAHi VisualNOS term=bold,underline cterm=bold,underline ctermbg=bg ctermfg=fg gui=bold,underline guibg=bg guifg=fg
    CSAHi WarningMsg term=NONE cterm=NONE ctermbg=245 ctermfg=16 gui=NONE guibg=#888888 guifg=#000000
    CSAHi WildMenu term=NONE cterm=NONE ctermbg=226 ctermfg=16 gui=NONE guibg=Yellow guifg=Black
    CSAHi Folded term=NONE cterm=NONE ctermbg=235 ctermfg=196 gui=NONE guibg=#222222 guifg=#ff0000
    ...
    CSAHi FoldColumn term=NONE cterm=NONE ctermbg=235 ctermfg=196 gui=NONE guibg=#222222 guifg=#ff0000
    CSAHi DiffAdd term=bold cterm=NONE ctermbg=236 ctermfg=46 gui=NONE guibg=#333333 guifg=#00ff00
    CSAHi DiffChange term=bold cterm=NONE ctermbg=236 ctermfg=46 gui=NONE guibg=#333333 guifg=#00ff00
    CSAHi DiffDelete term=bold cterm=bold ctermbg=236 ctermfg=46 gui=bold guibg=#333333 guifg=#00ff00
...
elseif has("gui_running") || &t_Co == 256
    ...
    CSAHi Error term=reverse cterm=NONE ctermbg=196 ctermfg=231 gui=NONE guibg=Red guifg=White
    CSAHi Todo term=NONE cterm=NONE ctermbg=16 ctermfg=196 gui=NONE guibg=#000000 guifg=#ff0000
    CSAHi String term=NONE cterm=NONE ctermbg=bg ctermfg=34 gui=NONE guibg=bg guifg=#00bb00
    CSAHi Boolean term=NONE cterm=NONE ctermbg=bg ctermfg=46 gui=NONE guibg=bg guifg=#00ff00
    CSAHi Function term=NONE cterm=NONE ctermbg=16 ctermfg=46 gui=NONE guibg=#000000 guifg=#00ff00
    CSAHi SpecialKey term=bold cterm=NONE ctermbg=16 ctermfg=46 gui=NONE guibg=#000000 guifg=#00ff00
    CSAHi NonText term=bold cterm=bold ctermbg=16 ctermfg=231 gui=bold guibg=#000000 guifg=#ffffff
    CSAHi Directory term=bold cterm=NONE ctermbg=16 ctermfg=46 gui=NONE guibg=#000000 guifg=#00ff00
    CSAHi ErrorMsg term=NONE cterm=NONE ctermbg=231 ctermfg=16 gui=NONE guibg=#ffffff guifg=#000000
    CSAHi IncSearch term=reverse cterm=NONE ctermbg=34 ctermfg=16 gui=NONE guibg=#00bb00 guifg=#000000
    CSAHi Search term=reverse cterm=NONE ctermbg=46 ctermfg=16 gui=NONE guibg=#00ff00 guifg=#000000
    CSAHi MoreMsg term=bold cterm=bold ctermbg=16 ctermfg=46 gui=bold guibg=#000000 guifg=#00ff00
    CSAHi ModeMsg term=bold cterm=bold ctermbg=16 ctermfg=46 gui=bold guibg=#000000 guifg=#00ff00
    CSAHi LineNr term=underline cterm=NONE ctermbg=16 ctermfg=28 gui=NONE guibg=#000000 guifg=#008800
    ...
    CSAHi cDefine term=NONE cterm=NONE ctermbg=bg ctermfg=46 gui=NONE guibg=bg guifg=#00ff00
    CSAHi Question term=NONE cterm=bold ctermbg=bg ctermfg=46 gui=bold guibg=bg guifg=#00ff00
    CSAHi StatusLine term=reverse,bold cterm=NONE ctermbg=28 ctermfg=16 gui=NONE guibg=#008800 guifg=#000000
    CSAHi StatusLineNC term=reverse cterm=NONE ctermbg=238 ctermfg=16 gui=NONE guibg=#444444 guifg=#000000
    CSAHi VertSplit term=reverse cterm=NONE ctermbg=16 ctermfg=231 gui=NONE guibg=#000000 guifg=#ffffff
    CSAHi Title term=bold cterm=NONE ctermbg=bg ctermfg=46 gui=NONE guibg=bg guifg=#00ff00
    CSAHi Visual term=reverse cterm=NONE ctermbg=40 ctermfg=16 gui=NONE guibg=#00dd00 guifg=#000000
    ...
    CSAHi Constant term=underline cterm=NONE ctermbg=bg ctermfg=46 gui=NONE guibg=bg guifg=#00ff00
    CSAHi Special term=bold cterm=NONE ctermbg=16 ctermfg=231 gui=NONE guibg=#000000 guifg=#ffffff
    CSAHi Identifier term=underline cterm=NONE ctermbg=16 ctermfg=34 gui=NONE guibg=#000000 guifg=#00bb00
    CSAHi Statement term=bold cterm=bold ctermbg=bg ctermfg=46 gui=bold guibg=bg guifg=#00ff00
    CSAHi PreProc term=underline cterm=NONE ctermbg=bg ctermfg=231 gui=NONE guibg=bg guifg=#ffffff
    CSAHi Type term=underline cterm=NONE ctermbg=bg ctermfg=231 gui=NONE guibg=bg guifg=#ffffff
    CSAHi FoldColumn term=NONE cterm=NONE ctermbg=235 ctermfg=196 gui=NONE guibg=#222222 guifg=#ff0000
...
elseif has("gui_running") || &t_Co == 88
    ...
    CSAHi String term=NONE cterm=NONE ctermbg=bg ctermfg=24 gui=NONE guibg=bg guifg=#00bb00
    CSAHi Boolean term=NONE cterm=NONE ctermbg=bg ctermfg=28 gui=NONE guibg=bg guifg=#00ff00
    CSAHi Function term=NONE cterm=NONE ctermbg=16 ctermfg=28 gui=NONE guibg=#000000 guifg=#00ff00
    CSAHi SpecialKey term=bold cterm=NONE ctermbg=16 ctermfg=28 gui=NONE guibg=#000000 guifg=#00ff00
    CSAHi NonText term=bold cterm=bold ctermbg=16 ctermfg=79 gui=bold guibg=#000000 guifg=#ffffff
    CSAHi Directory term=bold cterm=NONE ctermbg=16 ctermfg=28 gui=NONE guibg=#000000 guifg=#00ff00
    CSAHi ErrorMsg term=NONE cterm=NONE ctermbg=79 ctermfg=16 gui=NONE guibg=#ffffff guifg=#000000
    CSAHi IncSearch term=reverse cterm=NONE ctermbg=24 ctermfg=16 gui=NONE guibg=#00bb00 guifg=#000000
    CSAHi Search term=reverse cterm=NONE ctermbg=28 ctermfg=16 gui=NONE guibg=#00ff00 guifg=#000000
    CSAHi MoreMsg term=bold cterm=bold ctermbg=16 ctermfg=28 gui=bold guibg=#000000 guifg=#00ff00
    CSAHi ModeMsg term=bold cterm=bold ctermbg=16 ctermfg=28 gui=bold guibg=#000000 guifg=#00ff00
    CSAHi LineNr term=underline cterm=NONE ctermbg=16 ctermfg=20 gui=NONE guibg=#000000 guifg=#008800
    ...
    CSAHi TabLineSel term=bold cterm=NONE ctermbg=20 ctermfg=16 gui=NONE guibg=#00aa00 guifg=#000000
    ...
    CSAHi cDefine term=NONE cterm=NONE ctermbg=bg ctermfg=28 gui=NONE guibg=bg guifg=#00ff00
    CSAHi Question term=NONE cterm=bold ctermbg=bg ctermfg=28 gui=bold guibg=bg guifg=#00ff00
    CSAHi StatusLine term=reverse,bold cterm=NONE ctermbg=20 ctermfg=16 gui=NONE guibg=#008800 guifg=#000000
    ...
    CSAHi Title term=bold cterm=NONE ctermbg=bg ctermfg=28 gui=NONE guibg=bg guifg=#00ff00
    CSAHi Visual term=reverse cterm=NONE ctermbg=24 ctermfg=16 gui=NONE guibg=#00dd00 guifg=#000000
    CSAHi VisualNOS term=bold,underline cterm=bold,underline ctermbg=bg ctermfg=fg gui=bold,underline guibg=bg guifg=fg
    ...
    CSAHi MatchParen term=reverse cterm=NONE ctermbg=80 ctermfg=28 gui=NONE guibg=#222222 guifg=#00ff00
    CSAHi Comment term=bold cterm=NONE ctermbg=bg ctermfg=82 gui=NONE guibg=bg guifg=#696969
    CSAHi Constant term=underline cterm=NONE ctermbg=bg ctermfg=28 gui=NONE guibg=bg guifg=#00ff00
    CSAHi Special term=bold cterm=NONE ctermbg=16 ctermfg=79 gui=NONE guibg=#000000 guifg=#ffffff
    CSAHi Identifier term=underline cterm=NONE ctermbg=16 ctermfg=24 gui=NONE guibg=#000000 guifg=#00bb00
    CSAHi Statement term=bold cterm=bold ctermbg=bg ctermfg=28 gui=bold guibg=bg guifg=#00ff00
    ...
    CSAHi DiffAdd term=bold cterm=NONE ctermbg=80 ctermfg=28 gui=NONE guibg=#333333 guifg=#00ff00
    CSAHi DiffChange term=bold cterm=NONE ctermbg=80 ctermfg=28 gui=NONE guibg=#333333 guifg=#00ff00
    CSAHi DiffDelete term=bold cterm=bold ctermbg=80 ctermfg=28 gui=bold guibg=#333333 guifg=#00ff00
