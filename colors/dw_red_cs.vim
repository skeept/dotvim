...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsole) || &term =~? "^konsole"
    ...
    CSAHi String term=NONE cterm=NONE ctermbg=bg ctermfg=160 gui=NONE guibg=bg guifg=#bb0000
    CSAHi Boolean term=NONE cterm=NONE ctermbg=bg ctermfg=196 gui=NONE guibg=bg guifg=#ff0000
    CSAHi Function term=NONE cterm=NONE ctermbg=16 ctermfg=196 gui=NONE guibg=#000000 guifg=#ff0000
    CSAHi SpecialKey term=bold cterm=NONE ctermbg=16 ctermfg=196 gui=NONE guibg=#000000 guifg=#ff0000
    CSAHi NonText term=bold cterm=bold ctermbg=16 ctermfg=231 gui=bold guibg=#000000 guifg=#ffffff
    CSAHi Directory term=bold cterm=NONE ctermbg=16 ctermfg=196 gui=NONE guibg=#000000 guifg=#ff0000
    CSAHi ErrorMsg term=NONE cterm=NONE ctermbg=231 ctermfg=16 gui=NONE guibg=#ffffff guifg=#000000
    CSAHi IncSearch term=reverse cterm=NONE ctermbg=160 ctermfg=16 gui=NONE guibg=#bb0000 guifg=#000000
    CSAHi Search term=reverse cterm=NONE ctermbg=196 ctermfg=16 gui=NONE guibg=#ff0000 guifg=#000000
    CSAHi MoreMsg term=bold cterm=bold ctermbg=16 ctermfg=196 gui=bold guibg=#000000 guifg=#ff0000
    CSAHi ModeMsg term=bold cterm=bold ctermbg=16 ctermfg=196 gui=bold guibg=#000000 guifg=#ff0000
    CSAHi LineNr term=underline cterm=NONE ctermbg=16 ctermfg=124 gui=NONE guibg=#000000 guifg=#880000
    ...
    CSAHi TabLineSel term=bold cterm=NONE ctermbg=124 ctermfg=16 gui=NONE guibg=#aa0000 guifg=#000000
    CSAHi TabLineFill term=reverse cterm=underline ctermbg=16 ctermfg=231 gui=underline guibg=#000000 guifg=#ffffff
    CSAHi CursorColumn term=reverse cterm=NONE ctermbg=16 ctermfg=fg gui=NONE guibg=#110000 guifg=fg
    CSAHi CursorLine term=underline cterm=NONE ctermbg=16 ctermfg=fg gui=NONE guibg=#180000 guifg=fg
    ...
    CSAHi cDefine term=NONE cterm=NONE ctermbg=bg ctermfg=196 gui=NONE guibg=bg guifg=#ff0000
    CSAHi Question term=NONE cterm=bold ctermbg=bg ctermfg=196 gui=bold guibg=bg guifg=#ff0000
    CSAHi StatusLine term=reverse,bold cterm=NONE ctermbg=196 ctermfg=16 gui=NONE guibg=#ff0000 guifg=#000000
    ...
    CSAHi Visual term=reverse cterm=NONE ctermbg=160 ctermfg=16 gui=NONE guibg=#dd0000 guifg=#000000
    ...
    CSAHi MatchParen term=reverse cterm=NONE ctermbg=235 ctermfg=196 gui=NONE guibg=#222222 guifg=#ff0000
    ...
    CSAHi Identifier term=underline cterm=NONE ctermbg=16 ctermfg=160 gui=NONE guibg=#000000 guifg=#cc0000
    CSAHi Statement term=bold cterm=bold ctermbg=bg ctermfg=196 gui=bold guibg=bg guifg=#ff0000
    ...
    CSAHi DiffAdd term=bold cterm=NONE ctermbg=59 ctermfg=196 gui=NONE guibg=#333333 guifg=#ff0000
    CSAHi DiffChange term=bold cterm=NONE ctermbg=59 ctermfg=196 gui=NONE guibg=#333333 guifg=#ff0000
    CSAHi DiffDelete term=bold cterm=bold ctermbg=59 ctermfg=196 gui=bold guibg=#333333 guifg=#ff0000
...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_eterm") && g:CSApprox_eterm) || &term =~? "^eterm"
    ...
    CSAHi PmenuThumb term=NONE cterm=NONE ctermbg=250 ctermfg=16 gui=reverse guibg=bg guifg=fg
    CSAHi TabLine term=underline cterm=NONE ctermbg=238 ctermfg=16 gui=NONE guibg=#444444 guifg=#000000
    CSAHi TabLineSel term=bold cterm=NONE ctermbg=160 ctermfg=16 gui=NONE guibg=#aa0000 guifg=#000000
    CSAHi TabLineFill term=reverse cterm=underline ctermbg=16 ctermfg=255 gui=underline guibg=#000000 guifg=#ffffff
    CSAHi CursorColumn term=reverse cterm=NONE ctermbg=16 ctermfg=fg gui=NONE guibg=#110000 guifg=fg
    CSAHi CursorLine term=underline cterm=NONE ctermbg=52 ctermfg=fg gui=NONE guibg=#180000 guifg=fg
    ...
    CSAHi Title term=bold cterm=NONE ctermbg=bg ctermfg=196 gui=NONE guibg=bg guifg=#ff0000
    CSAHi Visual term=reverse cterm=NONE ctermbg=196 ctermfg=16 gui=NONE guibg=#dd0000 guifg=#000000
    CSAHi VisualNOS term=bold,underline cterm=bold,underline ctermbg=bg ctermfg=fg gui=bold,underline guibg=bg guifg=fg
    CSAHi WarningMsg term=NONE cterm=NONE ctermbg=245 ctermfg=16 gui=NONE guibg=#888888 guifg=#000000
    CSAHi WildMenu term=NONE cterm=NONE ctermbg=226 ctermfg=16 gui=NONE guibg=Yellow guifg=Black
    CSAHi Folded term=NONE cterm=NONE ctermbg=235 ctermfg=196 gui=NONE guibg=#222222 guifg=#ff0000
    ...
    CSAHi Identifier term=underline cterm=NONE ctermbg=16 ctermfg=196 gui=NONE guibg=#000000 guifg=#cc0000
    CSAHi Statement term=bold cterm=bold ctermbg=bg ctermfg=196 gui=bold guibg=bg guifg=#ff0000
    ...
    CSAHi FoldColumn term=NONE cterm=NONE ctermbg=235 ctermfg=196 gui=NONE guibg=#222222 guifg=#ff0000
    CSAHi DiffAdd term=bold cterm=NONE ctermbg=236 ctermfg=196 gui=NONE guibg=#333333 guifg=#ff0000
    CSAHi DiffChange term=bold cterm=NONE ctermbg=236 ctermfg=196 gui=NONE guibg=#333333 guifg=#ff0000
    CSAHi DiffDelete term=bold cterm=bold ctermbg=236 ctermfg=196 gui=bold guibg=#333333 guifg=#ff0000
...
elseif has("gui_running") || &t_Co == 256
    ...
    CSAHi Error term=reverse cterm=NONE ctermbg=196 ctermfg=231 gui=NONE guibg=Red guifg=White
    CSAHi Todo term=NONE cterm=NONE ctermbg=16 ctermfg=196 gui=NONE guibg=#000000 guifg=#ff0000
    CSAHi String term=NONE cterm=NONE ctermbg=bg ctermfg=124 gui=NONE guibg=bg guifg=#bb0000
    CSAHi Boolean term=NONE cterm=NONE ctermbg=bg ctermfg=196 gui=NONE guibg=bg guifg=#ff0000
    CSAHi Function term=NONE cterm=NONE ctermbg=16 ctermfg=196 gui=NONE guibg=#000000 guifg=#ff0000
    CSAHi SpecialKey term=bold cterm=NONE ctermbg=16 ctermfg=196 gui=NONE guibg=#000000 guifg=#ff0000
    CSAHi NonText term=bold cterm=bold ctermbg=16 ctermfg=231 gui=bold guibg=#000000 guifg=#ffffff
    CSAHi Directory term=bold cterm=NONE ctermbg=16 ctermfg=196 gui=NONE guibg=#000000 guifg=#ff0000
    CSAHi ErrorMsg term=NONE cterm=NONE ctermbg=231 ctermfg=16 gui=NONE guibg=#ffffff guifg=#000000
    CSAHi IncSearch term=reverse cterm=NONE ctermbg=124 ctermfg=16 gui=NONE guibg=#bb0000 guifg=#000000
    CSAHi Search term=reverse cterm=NONE ctermbg=196 ctermfg=16 gui=NONE guibg=#ff0000 guifg=#000000
    CSAHi MoreMsg term=bold cterm=bold ctermbg=16 ctermfg=196 gui=bold guibg=#000000 guifg=#ff0000
    CSAHi ModeMsg term=bold cterm=bold ctermbg=16 ctermfg=196 gui=bold guibg=#000000 guifg=#ff0000
    CSAHi LineNr term=underline cterm=NONE ctermbg=16 ctermfg=88 gui=NONE guibg=#000000 guifg=#880000
...
elseif has("gui_running") || &t_Co == 88
    ...
    CSAHi String term=NONE cterm=NONE ctermbg=bg ctermfg=48 gui=NONE guibg=bg guifg=#bb0000
    CSAHi Boolean term=NONE cterm=NONE ctermbg=bg ctermfg=64 gui=NONE guibg=bg guifg=#ff0000
    CSAHi Function term=NONE cterm=NONE ctermbg=16 ctermfg=64 gui=NONE guibg=#000000 guifg=#ff0000
    CSAHi SpecialKey term=bold cterm=NONE ctermbg=16 ctermfg=64 gui=NONE guibg=#000000 guifg=#ff0000
    CSAHi NonText term=bold cterm=bold ctermbg=16 ctermfg=79 gui=bold guibg=#000000 guifg=#ffffff
    CSAHi Directory term=bold cterm=NONE ctermbg=16 ctermfg=64 gui=NONE guibg=#000000 guifg=#ff0000
    CSAHi ErrorMsg term=NONE cterm=NONE ctermbg=79 ctermfg=16 gui=NONE guibg=#ffffff guifg=#000000
    CSAHi IncSearch term=reverse cterm=NONE ctermbg=48 ctermfg=16 gui=NONE guibg=#bb0000 guifg=#000000
    CSAHi Search term=reverse cterm=NONE ctermbg=64 ctermfg=16 gui=NONE guibg=#ff0000 guifg=#000000
    CSAHi MoreMsg term=bold cterm=bold ctermbg=16 ctermfg=64 gui=bold guibg=#000000 guifg=#ff0000
    CSAHi ModeMsg term=bold cterm=bold ctermbg=16 ctermfg=64 gui=bold guibg=#000000 guifg=#ff0000
    CSAHi LineNr term=underline cterm=NONE ctermbg=16 ctermfg=32 gui=NONE guibg=#000000 guifg=#880000
    ...
    CSAHi TabLineSel term=bold cterm=NONE ctermbg=32 ctermfg=16 gui=NONE guibg=#aa0000 guifg=#000000
    ...
    CSAHi cDefine term=NONE cterm=NONE ctermbg=bg ctermfg=64 gui=NONE guibg=bg guifg=#ff0000
    CSAHi Question term=NONE cterm=bold ctermbg=bg ctermfg=64 gui=bold guibg=bg guifg=#ff0000
    CSAHi StatusLine term=reverse,bold cterm=NONE ctermbg=64 ctermfg=16 gui=NONE guibg=#ff0000 guifg=#000000
    ...
    CSAHi Visual term=reverse cterm=NONE ctermbg=48 ctermfg=16 gui=NONE guibg=#dd0000 guifg=#000000
    CSAHi VisualNOS term=bold,underline cterm=bold,underline ctermbg=bg ctermfg=fg gui=bold,underline guibg=bg guifg=fg
    ...
    CSAHi MatchParen term=reverse cterm=NONE ctermbg=80 ctermfg=64 gui=NONE guibg=#222222 guifg=#ff0000
    ...
    CSAHi Identifier term=underline cterm=NONE ctermbg=16 ctermfg=48 gui=NONE guibg=#000000 guifg=#cc0000
    CSAHi Statement term=bold cterm=bold ctermbg=bg ctermfg=64 gui=bold guibg=bg guifg=#ff0000
    ...
    CSAHi DiffAdd term=bold cterm=NONE ctermbg=80 ctermfg=64 gui=NONE guibg=#333333 guifg=#ff0000
    CSAHi DiffChange term=bold cterm=NONE ctermbg=80 ctermfg=64 gui=NONE guibg=#333333 guifg=#ff0000
    CSAHi DiffDelete term=bold cterm=bold ctermbg=80 ctermfg=64 gui=bold guibg=#333333 guifg=#ff0000
