...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsole) || &term =~? "^konsole"
    ...
    CSAHi String term=NONE cterm=NONE ctermbg=bg ctermfg=164 gui=NONE guibg=bg guifg=#bb00bb
    CSAHi Boolean term=NONE cterm=NONE ctermbg=bg ctermfg=201 gui=NONE guibg=bg guifg=#ff00ff
    CSAHi Function term=NONE cterm=NONE ctermbg=16 ctermfg=201 gui=NONE guibg=#000000 guifg=#ff00ff
    CSAHi SpecialKey term=bold cterm=NONE ctermbg=16 ctermfg=201 gui=NONE guibg=#000000 guifg=#ff00ff
    CSAHi NonText term=bold cterm=bold ctermbg=16 ctermfg=231 gui=bold guibg=#000000 guifg=#ffffff
    CSAHi Directory term=bold cterm=NONE ctermbg=16 ctermfg=201 gui=NONE guibg=#000000 guifg=#ff00ff
    CSAHi ErrorMsg term=NONE cterm=NONE ctermbg=231 ctermfg=16 gui=NONE guibg=#ffffff guifg=#000000
    CSAHi IncSearch term=reverse cterm=NONE ctermbg=164 ctermfg=16 gui=NONE guibg=#bb00bb guifg=#000000
    CSAHi Search term=reverse cterm=NONE ctermbg=201 ctermfg=16 gui=NONE guibg=#ff00ff guifg=#000000
    CSAHi MoreMsg term=bold cterm=bold ctermbg=16 ctermfg=201 gui=bold guibg=#000000 guifg=#ff00ff
    CSAHi ModeMsg term=bold cterm=bold ctermbg=16 ctermfg=201 gui=bold guibg=#000000 guifg=#ff00ff
    CSAHi LineNr term=underline cterm=NONE ctermbg=16 ctermfg=127 gui=NONE guibg=#000000 guifg=#880088
    ...
    CSAHi TabLineSel term=bold cterm=NONE ctermbg=127 ctermfg=16 gui=NONE guibg=#aa00aa guifg=#000000
    CSAHi TabLineFill term=reverse cterm=underline ctermbg=16 ctermfg=231 gui=underline guibg=#000000 guifg=#ffffff
    CSAHi CursorColumn term=reverse cterm=NONE ctermbg=16 ctermfg=fg gui=NONE guibg=#110011 guifg=fg
    CSAHi CursorLine term=underline cterm=NONE ctermbg=16 ctermfg=fg gui=NONE guibg=#180018 guifg=fg
    ...
    CSAHi cDefine term=NONE cterm=NONE ctermbg=bg ctermfg=201 gui=NONE guibg=bg guifg=#ff00ff
    CSAHi Question term=NONE cterm=bold ctermbg=bg ctermfg=201 gui=bold guibg=bg guifg=#ff00ff
    CSAHi StatusLine term=reverse,bold cterm=NONE ctermbg=201 ctermfg=16 gui=NONE guibg=#ff00ff guifg=#000000
    ...
    CSAHi Visual term=reverse cterm=NONE ctermbg=164 ctermfg=16 gui=NONE guibg=#dd00dd guifg=#000000
    ...
    CSAHi MatchParen term=reverse cterm=NONE ctermbg=235 ctermfg=201 gui=NONE guibg=#222222 guifg=#ff00ff
    ...
    CSAHi Identifier term=underline cterm=NONE ctermbg=16 ctermfg=164 gui=NONE guibg=#000000 guifg=#cc00cc
    CSAHi Statement term=bold cterm=bold ctermbg=bg ctermfg=201 gui=bold guibg=bg guifg=#ff00ff
    ...
    CSAHi DiffAdd term=bold cterm=NONE ctermbg=59 ctermfg=201 gui=NONE guibg=#333333 guifg=#ff00ff
    CSAHi DiffChange term=bold cterm=NONE ctermbg=59 ctermfg=201 gui=NONE guibg=#333333 guifg=#ff00ff
    CSAHi DiffDelete term=bold cterm=bold ctermbg=59 ctermfg=201 gui=bold guibg=#333333 guifg=#ff00ff
...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_eterm") && g:CSApprox_eterm) || &term =~? "^eterm"
    ...
    CSAHi PmenuThumb term=NONE cterm=NONE ctermbg=250 ctermfg=16 gui=reverse guibg=bg guifg=fg
    CSAHi TabLine term=underline cterm=NONE ctermbg=238 ctermfg=16 gui=NONE guibg=#444444 guifg=#000000
    CSAHi TabLineSel term=bold cterm=NONE ctermbg=164 ctermfg=16 gui=NONE guibg=#aa00aa guifg=#000000
    CSAHi TabLineFill term=reverse cterm=underline ctermbg=16 ctermfg=255 gui=underline guibg=#000000 guifg=#ffffff
    CSAHi CursorColumn term=reverse cterm=NONE ctermbg=16 ctermfg=fg gui=NONE guibg=#110011 guifg=fg
    CSAHi CursorLine term=underline cterm=NONE ctermbg=53 ctermfg=fg gui=NONE guibg=#180018 guifg=fg
    ...
    CSAHi Title term=bold cterm=NONE ctermbg=bg ctermfg=201 gui=NONE guibg=bg guifg=#ff00ff
    CSAHi Visual term=reverse cterm=NONE ctermbg=201 ctermfg=16 gui=NONE guibg=#dd00dd guifg=#000000
    CSAHi VisualNOS term=bold,underline cterm=bold,underline ctermbg=bg ctermfg=fg gui=bold,underline guibg=bg guifg=fg
    CSAHi WarningMsg term=NONE cterm=NONE ctermbg=245 ctermfg=16 gui=NONE guibg=#888888 guifg=#000000
    CSAHi WildMenu term=NONE cterm=NONE ctermbg=226 ctermfg=16 gui=NONE guibg=Yellow guifg=Black
    CSAHi Folded term=NONE cterm=NONE ctermbg=235 ctermfg=196 gui=NONE guibg=#222222 guifg=#ff0000
    ...
    CSAHi Identifier term=underline cterm=NONE ctermbg=16 ctermfg=201 gui=NONE guibg=#000000 guifg=#cc00cc
    CSAHi Statement term=bold cterm=bold ctermbg=bg ctermfg=201 gui=bold guibg=bg guifg=#ff00ff
    ...
    CSAHi FoldColumn term=NONE cterm=NONE ctermbg=235 ctermfg=196 gui=NONE guibg=#222222 guifg=#ff0000
    CSAHi DiffAdd term=bold cterm=NONE ctermbg=236 ctermfg=201 gui=NONE guibg=#333333 guifg=#ff00ff
    CSAHi DiffChange term=bold cterm=NONE ctermbg=236 ctermfg=201 gui=NONE guibg=#333333 guifg=#ff00ff
    CSAHi DiffDelete term=bold cterm=bold ctermbg=236 ctermfg=201 gui=bold guibg=#333333 guifg=#ff00ff
...
elseif has("gui_running") || &t_Co == 256
    ...
    CSAHi Error term=reverse cterm=NONE ctermbg=196 ctermfg=231 gui=NONE guibg=Red guifg=White
    CSAHi Todo term=NONE cterm=NONE ctermbg=16 ctermfg=196 gui=NONE guibg=#000000 guifg=#ff0000
    CSAHi String term=NONE cterm=NONE ctermbg=bg ctermfg=127 gui=NONE guibg=bg guifg=#bb00bb
    CSAHi Boolean term=NONE cterm=NONE ctermbg=bg ctermfg=201 gui=NONE guibg=bg guifg=#ff00ff
    CSAHi Function term=NONE cterm=NONE ctermbg=16 ctermfg=201 gui=NONE guibg=#000000 guifg=#ff00ff
    CSAHi SpecialKey term=bold cterm=NONE ctermbg=16 ctermfg=201 gui=NONE guibg=#000000 guifg=#ff00ff
    CSAHi NonText term=bold cterm=bold ctermbg=16 ctermfg=231 gui=bold guibg=#000000 guifg=#ffffff
    CSAHi Directory term=bold cterm=NONE ctermbg=16 ctermfg=201 gui=NONE guibg=#000000 guifg=#ff00ff
    CSAHi ErrorMsg term=NONE cterm=NONE ctermbg=231 ctermfg=16 gui=NONE guibg=#ffffff guifg=#000000
    CSAHi IncSearch term=reverse cterm=NONE ctermbg=127 ctermfg=16 gui=NONE guibg=#bb00bb guifg=#000000
    CSAHi Search term=reverse cterm=NONE ctermbg=201 ctermfg=16 gui=NONE guibg=#ff00ff guifg=#000000
    CSAHi MoreMsg term=bold cterm=bold ctermbg=16 ctermfg=201 gui=bold guibg=#000000 guifg=#ff00ff
    CSAHi ModeMsg term=bold cterm=bold ctermbg=16 ctermfg=201 gui=bold guibg=#000000 guifg=#ff00ff
    CSAHi LineNr term=underline cterm=NONE ctermbg=16 ctermfg=90 gui=NONE guibg=#000000 guifg=#880088
...
elseif has("gui_running") || &t_Co == 88
    ...
    CSAHi String term=NONE cterm=NONE ctermbg=bg ctermfg=50 gui=NONE guibg=bg guifg=#bb00bb
    CSAHi Boolean term=NONE cterm=NONE ctermbg=bg ctermfg=67 gui=NONE guibg=bg guifg=#ff00ff
    CSAHi Function term=NONE cterm=NONE ctermbg=16 ctermfg=67 gui=NONE guibg=#000000 guifg=#ff00ff
    CSAHi SpecialKey term=bold cterm=NONE ctermbg=16 ctermfg=67 gui=NONE guibg=#000000 guifg=#ff00ff
    CSAHi NonText term=bold cterm=bold ctermbg=16 ctermfg=79 gui=bold guibg=#000000 guifg=#ffffff
    CSAHi Directory term=bold cterm=NONE ctermbg=16 ctermfg=67 gui=NONE guibg=#000000 guifg=#ff00ff
    CSAHi ErrorMsg term=NONE cterm=NONE ctermbg=79 ctermfg=16 gui=NONE guibg=#ffffff guifg=#000000
    CSAHi IncSearch term=reverse cterm=NONE ctermbg=50 ctermfg=16 gui=NONE guibg=#bb00bb guifg=#000000
    CSAHi Search term=reverse cterm=NONE ctermbg=67 ctermfg=16 gui=NONE guibg=#ff00ff guifg=#000000
    CSAHi MoreMsg term=bold cterm=bold ctermbg=16 ctermfg=67 gui=bold guibg=#000000 guifg=#ff00ff
    CSAHi ModeMsg term=bold cterm=bold ctermbg=16 ctermfg=67 gui=bold guibg=#000000 guifg=#ff00ff
    CSAHi LineNr term=underline cterm=NONE ctermbg=16 ctermfg=33 gui=NONE guibg=#000000 guifg=#880088
    ...
    CSAHi TabLineSel term=bold cterm=NONE ctermbg=33 ctermfg=16 gui=NONE guibg=#aa00aa guifg=#000000
    ...
    CSAHi cDefine term=NONE cterm=NONE ctermbg=bg ctermfg=67 gui=NONE guibg=bg guifg=#ff00ff
    CSAHi Question term=NONE cterm=bold ctermbg=bg ctermfg=67 gui=bold guibg=bg guifg=#ff00ff
    CSAHi StatusLine term=reverse,bold cterm=NONE ctermbg=67 ctermfg=16 gui=NONE guibg=#ff00ff guifg=#000000
    ...
    CSAHi Visual term=reverse cterm=NONE ctermbg=50 ctermfg=16 gui=NONE guibg=#dd00dd guifg=#000000
    CSAHi VisualNOS term=bold,underline cterm=bold,underline ctermbg=bg ctermfg=fg gui=bold,underline guibg=bg guifg=fg
    ...
    CSAHi MatchParen term=reverse cterm=NONE ctermbg=80 ctermfg=67 gui=NONE guibg=#222222 guifg=#ff00ff
    ...
    CSAHi Identifier term=underline cterm=NONE ctermbg=16 ctermfg=50 gui=NONE guibg=#000000 guifg=#cc00cc
    CSAHi Statement term=bold cterm=bold ctermbg=bg ctermfg=67 gui=bold guibg=bg guifg=#ff00ff
    ...
    CSAHi DiffAdd term=bold cterm=NONE ctermbg=80 ctermfg=67 gui=NONE guibg=#333333 guifg=#ff00ff
    CSAHi DiffChange term=bold cterm=NONE ctermbg=80 ctermfg=67 gui=NONE guibg=#333333 guifg=#ff00ff
    CSAHi DiffDelete term=bold cterm=bold ctermbg=80 ctermfg=67 gui=bold guibg=#333333 guifg=#ff00ff
